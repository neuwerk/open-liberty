...
public class HttpHandlerImpl extends HttpHandler {
    ...
    private final JaxWsHttpDestination destination;

    public HttpHandlerImpl(JaxWsHttpDestination destination) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            //service request
            destination.doService(new JaxWSCXFHttpServletRequestAdapter(exchange),
                                  new JaxWsHttpServletResponseAdapter(exchange));
        } finally {
            exchange.close();
        }
    }
