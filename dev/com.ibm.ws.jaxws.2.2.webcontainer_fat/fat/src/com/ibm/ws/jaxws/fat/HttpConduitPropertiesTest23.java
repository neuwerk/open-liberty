...
public class HttpConduitPropertiesTest23 extends AbstractHttpConduitPropertiesTest {
    ...
    public static void setup() throws Exception {
        ...
        server.setServerConfigurationFile("HttpConduitPropertiesTest/jaxwsTest-2.3_server.xml");
