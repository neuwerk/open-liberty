...
set CLASSPATH=%CLASSPATH%;%FVT_base_dir%\common\jars\twas\urlprotocols.jar;%FVT_base_dir%\common\jars\JSTAF.jar;%FVT_base_dir%\common\jars\setenvtask.jar;%FVT_base_dir%\common\jars\fattest.simplicity.jar;%FVT_base_dir%\common\jars\public.api.jar;%FVT_base_dir%\common\jars\provider.api.jar;%FVT_base_dir%\common\jars\provider.wsadmin.jar;%FVT_base_dir%\common\jars\provider.rxa.jar;%FVT_base_dir%\common\jars\jiiws.jar;%FVT_base_dir%\common\jars\jlanclient.jar;%FVT_base_dir%\common\jars\remoteaccess.jar;%FVT_base_dir%\common\jars\ssh.jar;%JUNIT_HOME%\junit.jar;%FVT_base_dir%\common\jars\jsse.jar;%FVT_base_dir%\common\jars\js.jar

rem set CLASSPATH=%CLASSPATH%;%FVT_base_dir%\common\jars\twas\urlprotocols.jar;%FVT_base_dir%\common\jars\JSTAF.jar;%FVT_base_dir%\common\jars\setenvtask.jar;%FVT_base_dir%\common\jars\fattest.simplicity.jar;%FVT_base_dir%\common\jars\provider.api.jar;%FVT_base_dir%\common\jars\provider.wsadmin.jar;%FVT_base_dir%\common\jars\provider.rxa.jar;%FVT_base_dir%\common\jars\jiiws.jar;%FVT_base_dir%\common\jars\jlanclient.jar;%FVT_base_dir%\common\jars\remoteaccess.jar;%FVT_base_dir%\common\jars\ssh.jar;%JUNIT_HOME%\junit.jar;%FVT_base_dir%\common\jars\jsse.jar;%FVT_base_dir%\common\jars\js.jar

rem Complete ANT_OPTS
set JPDA_OPTS=-Xdebug -Xrunjdwp:transport=dt_socket,address=5006,server=y,suspend=n
set ANT_OPTS=%JPDA_OPTS% -DWAS.base.dir=%WAS_TOP%  -Djavax.xml.transform.TransformerFactory=org.apache.xalan.processor.TransformerFactoryImpl -DFVT.base.dir=%FVT_base_dir% -DsimplicityConfigProps=%FVT_base_dir%\simplicityConfig.props -DbootstrappingPropsFile=%FVT_base_dir%\bootstrapping.properties -Djava.endorsed.dirs=%FVT_base_dir%\common\jars\endorsed
...
:usage
        ...
        echo Usage: unittest.bat FVT_TOP WAS_TOP build_number CMVC_Release [JAVA_HOME or Ant Targets]
        echo.
