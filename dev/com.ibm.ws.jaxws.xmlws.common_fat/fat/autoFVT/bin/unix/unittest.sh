...
#
# FVT/ws/code/websvcs.fvt/bin/unix/unittest.sh, WAS.websvcs.fvt, WAS85.FVT, cf011231.01
#
...
if [ "$platform" = "HP-UX" ]; then
   ...
   echo "<property environment=\"env\"/>" >> $FVT_TOP/FVT/ws/code/websvcs.fvt/instance.xml
fi
...
ENDORSED_DIRS="$WAS_TOP/endorsed_apis:$WAS_TOP/java/jre/lib/endorsed"
...
if [ "$platform" = "SunOS" ]; then
   ...
   echo "<property name=\"hp64StafFlag\" value=\"-d64\" />" >> $FVT_TOP/FVT/ws/code/websvcs.fvt/instance.xml
   echo "<property name=\"junit.jvm.xmx\"" value=\"-Xmx1024m\"" />" >> $FVT_TOP/FVT/ws/code/websvcs.fvt/instance.xml
   echo "<property name=\"compile.foreach.fork\" value=\"no\" />" >> $FVT_TOP/FVT/ws/code/websvcs.fvt/instance.xml
   echo "<property name=\"run.buildtestcase.fork\" value=\"no\" />" >> $FVT_TOP/FVT/ws/code/websvcs.fvt/instance.xml
      fi    
    fi
...
FVT_base_dir="$FVT_TOP/FVT/ws/code/websvcs.fvt"
export FVT_base_dir

ANT_OPTS="$ANT_OPTS -DFVT.base.dir=$FVT_base_dir -DsimplicityConfigProps=$FVT_base_dir/simplicityConfig.props -DbootstrappingPropsFile=$FVT_base_dir/bootstrapping.properties"

echo the ANT_OPTS environment variable is $ANT_OPTS
export ANT_OPTS

CMD="ant -DANT.base.dir=$ANT_HOME $SPECIAL_ANT_OPTS -DFVT.base.dir=$FVT_TOP/FVT/ws/code/websvcs.fvt -DWAS.base.dir=$WAS_TOP -f $FVT_TOP/FVT/ws/code/websvcs.fvt/preBuildTest.xml"
$CMD

if [ "$platform" = "OS/390" ] &&
   [ ! -f $FVT_TOP/FVT/ws/code/websvcs.fvt/setup-zos ]; then
    # Don't run a2e more than once on the same file
    a2e $FVT_TOP/FVT/ws/code/websvcs.fvt/bin/unix/mp.sh
    chmod 777 $FVT_TOP/FVT/ws/code/websvcs.fvt/bin/unix/mp.sh
    CMD="ant -DANT.base.dir=$ANT_HOME -DFVT.base.dir=$FVT_TOP/FVT/ws/code/websvcs.fvt -DWAS.base.dir=$WAS_TOP -f $FVT_TOP/FVT/ws/code/websvcs.fvt/preBuildTest.xml setupZOS"
    $CMD
fi
