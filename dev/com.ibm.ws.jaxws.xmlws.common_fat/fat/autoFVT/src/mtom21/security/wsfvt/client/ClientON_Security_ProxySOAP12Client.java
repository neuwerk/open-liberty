//
// @(#) 1.1 autoFVT/src/mtom21/security/wsfvt/client/ClientON_Security_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:39:13 [8/8/12 06:41:00]
//
...
public class ClientON_Security_ProxySOAP12Client {
    ...
    private String endpointUrlProxy = "https://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM_SECURE@/mtomsecurity21/SecurityMtomOffProxySOAP12Service";

    private String http_endpointUrlProxy = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtomsecurity21/SecurityMtomOffProxySOAP12Service";
    ...
    public String proxyClient_AttachmentLargeJpeg_SOAPProvider() {
        ...
        System.out.println("\n*** In ClientON_Security_ProxySOAP12Client.proxyClient_AttachmentLargeJpeg_SOAPProvider ***\n");
     ...
     * server sends the image back using SOAP 1.2 with MTOM disabled. The client examines the
     * response message and verifies that MTOM was not used in the response.
     */
    public String soapClient_AttachmentLargeJpeg_ProxyServer() {

        QName serviceName = new QName("http://org/test/mtom21/SecurityMtomOffProxySOAP12",
                "SecurityMtomOffProxySOAP12Service");
        QName portName = new QName("http://org/test/mtom21/SecurityMtomOffProxySOAP12", "AttachmentServicePort");

        System.out.println("\n*** In ClientON_Security_ProxySOAP12Client.soapClient_AttachmentLargeJpeg_ProxyServer ***\n");
        ...
        try {
            ...
            SOAPBodyElement payload = body.addBodyElement(new QName("http://org/test/mtom21/SecurityMtomOffProxySOAP12", "sendImage"));
     ...
     */
    public String proxyClient_AttachmentLargeJpeg_proxyServer() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_Security_ProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");
        System.out.println("portname = " + portName + ",endpointUrl = " + endpointUrlProxy);
        ...
        //Set the data inside of the appropriate object
        org.test.mtom21.securitymtomoffproxysoap12.ImageDepot imageDepot = new org.test.mtom21.securitymtomoffproxysoap12.ObjectFactory().createImageDepot();
        imageDepot.setImageData(content);
        ...
        org.test.mtom21.securitymtomoffproxysoap12.ImageServiceInterface proxy = svc.getPort(portName, org.test.mtom21.securitymtomoffproxysoap12.ImageServiceInterface.class, mtom21);
        ...
        //Send the image and process the response image
        org.test.mtom21.securitymtomoffproxysoap12.ImageDepot response = proxy.sendImage(imageDepot);
        if (response != null) {
            System.out.println("-- Response received");
