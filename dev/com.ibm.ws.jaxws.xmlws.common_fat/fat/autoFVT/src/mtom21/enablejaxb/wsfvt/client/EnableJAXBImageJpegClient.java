//
// @(#) 1.1 autoFVT/src/mtom21/enablejaxb/wsfvt/client/EnableJAXBImageJpegClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:29:31 [8/8/12 06:40:49]
//
 ...
 * client. - service has MTOM = default (no setting) - exclusively enables MTOM using
 * binding.setMTOMEnabled(true);
 */

public class EnableJAXBImageJpegClient {
    ...
    public String jaxb_AttachmentSmallJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBImageJpegClient.jaxb_AttachmentSmallJpeg_VerifyMTOM ***\n");
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBImageJpegClient.JAXB_AttachmentSmallJpeg ***\n");
    ...
    public String jaxb_AttachmentLargeJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBImageJpegClient.jaxb_AttachmentLargeJpeg_VerifyMTOM ***\n");
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
            ...
            // set MTOM on dispatch
            MTOMFeature mtom21 = new MTOMFeature(true, 0);
    ...
    public String JAXB_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBImageJpegClient.JAXB_AttachmentLargeJpeg ***\n");
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
    ...
    public String jaxb_Sequence_SmallJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In JAXB_Sequence_SmallJpeg.jaxb_Sequence_SmallJpeg_VerifyMTOM ***\n");
    ...
    public String JAXB_Sequence_SmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In JAXB_Sequence_SmallJpeg.JAXB_AttachmentSmallJpeg ***\n");
