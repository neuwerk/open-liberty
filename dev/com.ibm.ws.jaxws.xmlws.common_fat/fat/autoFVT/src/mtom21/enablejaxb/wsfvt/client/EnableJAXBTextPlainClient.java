...
// 05/12/08 jramos      520111          Change verification to expect MTOMOFF. MTOM not used for text/plain
...
public class EnableJAXBTextPlainClient {
    ...
    public static final QName serviceName = new QName("http://ws.apache.org/axis2", "EnableJAXBTextPlainService");
    ...
    private static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/enablejaxb21/EnableJAXBTextPlainService";

    public static final QName serviceNameVerify = new QName("http://ws.apache.org/axis2", "EnableJAXBTextPlainServiceVerifyMTOM");
    ...
    private static final String endpointUrlVerify = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/enablejaxb21/EnableJAXBTextPlainServiceVerifyMTOM";
	...
	public static void main(String[] args) {
	    try {
            ...
            client.jaxb_AttachmentShortString_VerifyMTOM();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public String jaxb_AttachmentShortString_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBTextPlainClient.jaxb_AttachmentShortString_VerifyMTOM ***\n");
        ...
        JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.enablejaxb_textplain");
        ...
        // MTOM should not be used for plain/text
    ...
    public String JAXB_AttachmentShortString() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBTextPlainClient.JAXB_AttachmentShortString ***\n");
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
    ...
    public String jaxb_AttachmentLongString_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBTextPlainClient.jaxb_AttachmentLongString_VerifyMTOM ***\n");
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
    ...
    public String JAXB_AttachmentLongString() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableJAXBTextPlainClient.JAXB_AttachmentLongString ***\n");
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
    ...
    public String jaxb_AttachmentFromFile_VerifyMTOM() throws Exception {
        ...
        System.out.println("\n*** In EnableJAXBTextPlainClient.jaxb_AttachmentFromFile_VerifyMTOM  ***\n");
   ...
   public String JAXB_AttachmentFromFile() throws Exception {
        ...
        System.out.println("\n*** In EnableJAXBTextPlainClient.JAXB_AttachmentFromFile  ***\n");
