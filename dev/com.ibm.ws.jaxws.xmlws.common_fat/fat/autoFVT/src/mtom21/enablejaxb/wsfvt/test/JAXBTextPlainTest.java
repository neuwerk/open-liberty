//
// @(#) 1.1 autoFVT/src/mtom21/enablejaxb/wsfvt/test/JAXBTextPlainTest.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:31:16 [8/8/12 06:40:51]
//
...
import mtom21.enablejaxb.wsfvt.client.EnableJAXBTextPlainClient;
...
public class JAXBTextPlainTest extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
    ...
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_ShortString_VerifyMTOM() throws Exception {
    ...
    // Test sending/receiving a message with in-line attachment = a short string
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_ShortString() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_LongString_VerifyMTOM() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_LongString() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_FromXMLFile_VerifyMTOM() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testDispatch_ServerDefault_ClientON_PlainTextMIME_FromXMLFile() throws Exception {
