//
// @(#) 1.1 autoFVT/src/mtom21/enablejaxb/wsfvt/client/SOAPMessageClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:29:59 [8/8/12 06:40:49]
//
 ...
 * - MTOM is enabled on the client and disabled on the service end point
 * - mode = Message
...
public class SOAPMessageClient {
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/enablejaxb21/ProviderSOAPMessageService";

    public static final String bindingID = SOAPBinding.SOAP11HTTP_MTOM_BINDING;
    public static final Service.Mode mode = Service.Mode.MESSAGE;

    public static final String extra_xmlns = " xmlns:env=\"http://www.w3.org/2003/05/soap-envelope\""; // one
    ...
    /**
     * This method will create a JAX-WS Dispatch object to call the remote method. It uses correct
     * header as defined in wsdl for the sending string
     * 
     * @return returned from the remote method
     */
    public String SOAPMessage_TextMessage() {

        System.out.println("\n***** In SOAPMessageClient.SOAPMessage_TextMessage *****\n");

        // create a service
        Service svc = Service.create(serviceName);
        svc.addPort(portName, bindingID, endpointUrl);

        System.out.println("- add Port: portName=" + portName + ",bindingID=" + bindingID + ",endpointURL="
                + endpointUrl);
        ...
        dispatch = svc.createDispatch(portName, SOAPMessage.class, mode, mtom);
    ...
    /**
     * This method will create a JAX-WS Dispatch object to call the remote method. It uses Source to
     * wrap the byte[] format of an image, with correct header as defined in wsdl
     * 
     * @return returned from the remote method
     */
    ...
    public String SOAPMessage_ImageMessage() {
        ...
        System.out.println("\n***** In SOAPMessageClient.SOAPMessage_ImageMessage *****\n");
