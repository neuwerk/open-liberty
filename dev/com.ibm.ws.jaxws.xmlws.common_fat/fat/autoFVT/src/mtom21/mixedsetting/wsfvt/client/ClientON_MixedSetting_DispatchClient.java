//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientON_MixedSetting_DispatchClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:41 [8/8/12 06:40:56]
//
...
public class ClientON_MixedSetting_DispatchClient {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "MtomOffDispatchService");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOffDispatchService";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_MixedSetting_DispatchClient.JAXB_AttachmentSmallJpeg() ***\n");
        ...
        try {
            ...
            JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.mtomoffdispatch");
    ...
    public String JAXB_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_MixedSetting_DispatchClient.JAXB_AttachmentLargeJpeg() ***\n");
