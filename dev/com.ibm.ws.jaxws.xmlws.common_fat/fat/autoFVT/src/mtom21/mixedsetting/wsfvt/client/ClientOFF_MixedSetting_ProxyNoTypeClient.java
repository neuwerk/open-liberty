//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_ProxyNoTypeClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:37 [8/8/12 06:40:56]
//
...
public class ClientOFF_MixedSetting_ProxyNoTypeClient {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "MtomOnProxyNoTypeService");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOnProxyNoTypeService";

    Service.Mode mode = Service.Mode.PAYLOAD;

	public static void main(String[] args) {
		try {
            ClientOFF_MixedSetting_ProxyNoTypeClient client = new ClientOFF_MixedSetting_ProxyNoTypeClient();
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSetting_ProxyNoTypeClient.Proxy_AttachmentSmallJpeg ***\n");
    ...
    /**
     * This testcase uses a JAXB generated objects This testcase covers the empty mime type in WSDL,
     * using Proxy Server has MTOM set to ON with SOAP11 Client has MTOM set to OFF Sends a large
     * jpeg image
     */
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSetting_ProxyNoTypeClient.Proxy_AttachmentLargeJpeg ***\n");
