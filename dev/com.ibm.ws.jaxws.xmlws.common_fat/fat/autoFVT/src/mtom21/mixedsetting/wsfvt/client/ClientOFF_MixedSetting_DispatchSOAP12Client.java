//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_DispatchSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:31 [8/8/12 06:40:56]
//
...
import org.test.mtom21.mtomondispatchsoap12.*;  // MtomOnDispatchSOAP12 - same as service 
...
public class ClientOFF_MixedSetting_DispatchSOAP12Client {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "MtomOnDispatchSOAP12Service");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOnDispatchSOAP12Service";
     ...
     * - client with MTOM = OFF with SOAP12    
     * - mode = PAYLOAD
    ...
    public String JAXB_AttachmentSmallJpeg_SOAP12() throws Exception {
        ...
        // debug
        System.out
                .println("\n*** In ClientOFF_MixedSetting_DispatchSOAP12Client.JAXB_AttachmentSmallJpeg_SOAP12() ***\n");
        ...
        try {
            ...
            JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.mtomondispatchsoap12");
    ...
    public String JAXB_AttachmentLargeJpeg_SOAP12() throws Exception {
        ...
        // debug
        System.out
                .println("\n*** In ClientOFF_MixedSetting_DispatchSOAP12Client.JAXB_AttachmentLargeJpeg_SOAP12() ***\n");
