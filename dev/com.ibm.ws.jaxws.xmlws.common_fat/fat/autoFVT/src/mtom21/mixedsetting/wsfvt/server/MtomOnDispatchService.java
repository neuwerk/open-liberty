//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/server/MtomOnDispatchService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:38:08 [8/8/12 06:40:57]
//
...
import org.test.mtom21.mtomondispatch.*;
/**
 * A JAXB implementation
 *
 */
@WebService(
		targetNamespace = "urn://MtomOnDispatch.mtom21.test.org",
		serviceName = "MtomOnDispatchService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/MtomOnDispatch.wsdl",
		endpointInterface = "org.test.mtom21.mtomondispatch.ImageServiceInterface")
