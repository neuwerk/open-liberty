//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientON_MixedSetting_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:47 [8/8/12 06:40:57]
//
...
import org.test.mtom21.mtomoffproxysoap12.*;  // mtomoffproxysoap12 - same as service
 ...
 * Server has MTOM = OFF with SOAP12
 * Client has MTOM = ON
 */


public class ClientON_MixedSetting_ProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom21/MtomOffProxySOAP12", "MtomOffProxySOAP12Service");
    QName portName    = new QName("http://org/test/mtom21/MtomOffProxySOAP12", "AttachmentServicePort");


    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOffProxySOAP12Service";
	...
	/**
	 * This testcase uses a JAXWS Proxy 
	 * with JAXB generated request object
	 * as parameter. 
	 * 
	 * - Service has MTOM disabled with SOAP1.2
	 * - sends small image (12K)
     * - Sets MTOM=enable in this client 
     * - mode = PAYLOAD
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_MixedSettingProxySOAP12Client.Proxy_AttachmentSmallJpeg ***\n");
     ...
     *  - Service has MTOM disabled with SOAP1.2 - sends small image (12K) - Sets MTOM=enable in
     * this client - mode = PAYLOAD
     * 
     * @return returned from the remote method
     */
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_MixedSettingProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");
    ...
    /**
     * This testcase uses a JAXB generated objects This testcase covers the "multipart/*" mime
     * types, using Proxy Server has MTOM set to OFF with SOAP12 Client has MTOM set to ON Sends an
     * XML file
     */
    ...
    public String Proxy_AttachmentFromXMLFile() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientON_MixedSettingProxySOAP12Client.Proxy_AttachmentFromXMLFile ***\n");
