//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:39 [8/8/12 06:40:56]
//
...
import org.test.mtom21.mtomonproxysoap12.*;
...
public class ClientOFF_MixedSetting_ProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom21/MtomOnProxySOAP12", "MtomOnProxySOAP12Service");
    QName portName = new QName("http://org/test/mtom21/MtomOnProxySOAP12", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOnProxySOAP12Service";
	...
	public static void main(String[] args) {
		try {
            ClientOFF_MixedSetting_ProxySOAP12Client client = new ClientOFF_MixedSetting_ProxySOAP12Client();
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxySOAP12Client.Proxy_AttachmentSmallJpeg ***\n");
     ...
     *  - Service has MTOM enabled with SOAP1.2 - sends small image (12K) - mode = PAYLOAD
     * @return returned from the remote method
     */
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");
     ...
     * types, using Proxy Server has MTOM set to ON with SOAP12 Sends an XML file
     */

    public String Proxy_AttachmentFromXMLFile() throws Exception {

        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxySOAP12Client.Proxy_AttachmentFromXMLFile ***\n");
