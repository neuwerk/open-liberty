//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_ProxyClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:33 [8/8/12 06:40:56]
//
...
import org.test.mtom21.mtomonproxy.*;
...
public class ClientOFF_MixedSetting_ProxyClient {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "MtomOnProxyService");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOnProxyService";
	...
	public static void main(String[] args) {
		try {
            ClientOFF_MixedSetting_ProxyClient client = new ClientOFF_MixedSetting_ProxyClient();
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxyClient.Proxy_AttachmentSmallJpeg ***\n");
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxyClient.Proxy_AttachmentLargeJpeg ***\n");
    ...
    public String Proxy_AttachmentFromXMLFile() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSettingProxyClient.Proxy_AttachmentFromXMLFile ***\n");
