//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientON_MixedSetting_ProxyNoTypeClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:46 [8/8/12 06:40:57]
//
...
public class ClientON_MixedSetting_ProxyNoTypeClient {
    ...
    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOffProxyNoTypeService";
     ...
     * using Proxy Server has MTOM set to OFF with SOAP11 Client has MTOM set to ON Sends a large
     * jpeg image
     */
