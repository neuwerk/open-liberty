//
// @(#) 1.1 autoFVT/src/mtom21/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_DispatchClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:37:28 [8/8/12 06:40:56]
//
...
import org.test.mtom21.mtomondispatch.*;  // MtomOnDispatch - same name with service
...
public class ClientOFF_MixedSetting_DispatchClient {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "MtomOnDispatchService");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting21/MtomOnDispatchService";
     ...
     * - client with MTOM = OFF with SOAP11    
     * - mode = PAYLOAD
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSetting_DispatchSOAP12Client.JAXB_AttachmentSmallJpeg() ***\n");
        ...
        try {
            ...
            JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.mtomondispatch");
    ...
    public String JAXB_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_MixedSetting_DispatchClient.JAXB_AttachmentLargeJpeg() ***\n");
