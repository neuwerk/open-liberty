//
// @(#) 1.1 autoFVT/src/mtom21/disablejaxb/wsfvt/client/DisableJAXBProviderSourceClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:24:18 [8/8/12 06:40:42]
//
...
// ----------------------------------------------------------------------------
// 03/10/08 jtnguyen    LIDB4418-12.01  New File
...
public class DisableJAXBProviderSourceClient {
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablejaxbanno/MTOMDefaultProviderSourceService";

    public static final QName serviceNameVerify = new QName("http://ws.apache.org/axis2", "MTOMDefaultProviderSourceServiceVerifyMTOM");
    ...
    public static final String endpointUrlVerify = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablejaxbanno/MTOMDefaultProviderSourceServiceVerifyMTOM";
    ...
    public String sourceSOAP11Payload_01_VerifyMTOM() throws Exception {
        ...
        // debug
        printMessageToConsole("***** In DisableJAXBProviderSourceClient.sourceSOAP11Payload_01_VerifyMTOM *****");
    ...
    /**
     * This method will create a JAX-WS Dispatch object to call the remote method. - sets for
     * MTOM=Diable with SOAP11 using 2 steps: bindingID and setMTOMEnabled - mode = PAYLOAD
     ...
     * @throws Exception
     */
    public String sourceSOAP11Payload_02_VerifyMTOM() throws Exception {

        // debug
        printMessageToConsole("***** In DisableJAXBProviderSourceClient.sourceSOAP11Payload_02_VerifyMTOM *****");
        ...
        String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
            ...
            // string after converting from Source result - can only called once because it changes
            // the source:
            String s = Common.toString(retVal);
            System.out.println("response: " + s);
            if (s != null && s.indexOf("MTOMOFF") != -1) {
    ...
    /**
     * This method will create a JAX-WS Dispatch object to call the remote method. - sets for
     * MTOM=disable with SOAP11 using 2 steps: bindingID and setMTOMEnabled - mode = PAYLOAD - uses
     * Source to wrap a string, with correct header as defined in wsdl
     * 
     * @return returned from the remote method
     */
     ...
     * @throws Exception
     */
    public String sourceSequenceSOAP11Payload_VerifyMTOM() throws Exception {
        ...
        // MTOM ON should not optimize the attachment
        if (s != null) {
            if (s.indexOf("MTOMOFF") != -1) {
