//
// @(#) 1.1 autoFVT/src/mtom21/disablejaxb/wsfvt/test/DisableJAXBProxyImageJpegTest.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:27:41 [8/8/12 06:40:44]
//
...
import mtom21.disablejaxb.wsfvt.client.DisableJAXBProxyImageJpegClient;
 ...
 * 
 */
public class DisableJAXBProxyImageJpegTest extends FVTTestCase {
    ...
    public void testProxy_ServerDefault_ClientOFF_ImageJpegMIME_smallJpeg_VerifyMTOM() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testProxy_ServerDefault_ClientOFF_ImageJpegMIME_smallJpeg() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testProxy_ServerDefault_ClientOFF_ImageJpegMIME_largeJpeg_VerifyMTOM() throws Exception {
    ...
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description = "", expectedResult = "", since = com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WAS70)
    public void testProxy_ServerDefault_ClientOFF_ImageJpegMIME_largeJpeg() throws Exception {
