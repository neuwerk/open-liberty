//
// @(#) 1.1 autoFVT/src/mtom21/disablejaxb/wsfvt/server/MTOMDefaultProviderSourceServiceVerifyMTOM.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:27:25 [8/8/12 06:40:44]
//
...
@WebServiceProvider(
        ...
        serviceName = "MTOMDefaultProviderSourceServiceVerifyMTOM",
        portName = "AttachmentServicePortVerifyMTOM",
        wsdlLocation="WEB-INF/wsdl/MTOMDefaultProviderSource.wsdl")
@MTOM(enabled=false, threshold=0)
	
public class MTOMDefaultProviderSourceServiceVerifyMTOM implements Provider<SOAPMessage> {
