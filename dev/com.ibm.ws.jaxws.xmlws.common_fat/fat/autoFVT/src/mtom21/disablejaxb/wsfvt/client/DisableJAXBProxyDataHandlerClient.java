//
// @(#) 1.1 autoFVT/src/mtom21/disablejaxb/wsfvt/client/DisableJAXBProxyDataHandlerClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:24:19 [8/8/12 06:40:42]
//
...
import org.test.mtom21.disablejaxbproxy_datahandler.*;

/**
 * This testcase uses a JAXB generated objects This testcase covers the "multipart/*" mime types,
 * using Proxy with MTOM = diable
 */

public class DisableJAXBProxyDataHandlerClient {
    ...
    public static final QName serviceName = new QName("http://ws.apache.org/axis2", "MTOMDefaultDataHandlerService");
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablejaxbanno/MTOMDefaultDataHandlerService";

    public static final QName serviceNameVerify = new QName("http://ws.apache.org/axis2", "MTOMDefaultDataHandlerServiceVerifyMTOM");
    ...
    public static final String endpointUrlVerify = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablejaxbanno/MTOMDefaultDataHandlerServiceVerifyMTOM";
    ...
    public String proxy_AttachmentSmallJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.proxy_AttachmentSmallJpeg_VerifyMTOM ***\n");
     ...
     *  - MTOM disabled via this client - sends small image (12K) - mode = PAYLOAD
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.Proxy_AttachmentSmallJpeg ***\n");
    ...
    public String proxy_AttachmentLargeJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.proxy_AttachmentLargeJpeg_VerifyMTOM ***\n");
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.Proxy_AttachmentLargeJpeg ***\n");
    ...
    public String proxy_SequenceLargeJpeg_VerifyMTOM() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.proxy_SequenceLargeJpeg_VerifyMTOM ***\n");
    ...
    public String Proxy_SequenceLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableJAXBProxyDataHandlerClient.Proxy_SequenceLargeJpeg ***\n");
        ...
        try {
            ...
            System.out.println("Proxy_SequenceLargeJpeg Client failed with exception.");
            ex.printStackTrace();
        }
