//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/ClientOFF_DisableSBProxyClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:08 [8/8/12 06:40:46]
//
 ...
 * using Proxy Server has MTOM set to OFF with SOAP11 Client has MTOM set to OFF
 */

public class ClientOFF_DisableSBProxyClient {
     ...
     *  - Service has MTOM disabled - sends small image (12K) - uses no setting for MTOM from client
     * (bindingID = null) - mode = PAYLOAD - no setting for SOAP version
     * 
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxyClient.Proxy_AttachmentSmallJpeg ***\n");
     ...
     * types, using Proxy Server has MTOM set to ON with SOAP11 Client has MTOM set to OFF Sends a
     * large jpeg image
     */
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxyClient.Proxy_AttachmentLargeJpeg ***\n");
    ...
    /**
     * This testcase uses a JAXB generated objects This testcase covers the "multipart/*" mime
     * types, using Proxy Server has MTOM set to ON with SOAP11 Client has MTOM set to OFF Sends an
     * XML file
     */
    ...
    public String Proxy_AttachmentFromXMLFile() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxyClient.Proxy_AttachmentFromXMLFile ***\n");
