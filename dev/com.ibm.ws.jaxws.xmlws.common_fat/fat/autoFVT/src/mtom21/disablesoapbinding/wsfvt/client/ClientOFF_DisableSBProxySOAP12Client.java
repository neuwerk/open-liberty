//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/ClientOFF_DisableSBProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:12 [8/8/12 06:40:46]
//
...
/**
 * This testcase uses a JAXB generated objects. - covers the ""image/jpeg" MIME types, using Proxy
 * client to send a message as dataHandler object. - service has MTOM = OFF with SOAP12 -
 * exclusively disables MTOM using binding.setMTOMEnabled(false);
 */

public class ClientOFF_DisableSBProxySOAP12Client {
    ...
    /**
     * This testcase uses a JAXWS Proxy with JAXB generated request object as parameter. - Service
     * has MTOM disabled with SOAP1.2 - sends small image (12K) - mode = PAYLOAD
     * 
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxySOAP12Client.Proxy_AttachmentSmallJpeg ***\n");
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");
     ...
     * types, using Proxy Server has MTOM set to OFF with SOAP12 Sends an XML file
     */

    public String Proxy_AttachmentFromXMLFile() throws Exception {

        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxySOAP12Client.Proxy_AttachmentFromXMLFile ***\n");
                ...
                try {
                    ...
                    while (line != null) {
                        ...
                        if (line.compareTo(sourceLine) != 0) {
                            // System.out.println("Line not the same: rec=\"" + line +
                            // "\",source=\"" + sourceLine);
                            failedNum++;
                        }
                        line = inputStream.readLine();
