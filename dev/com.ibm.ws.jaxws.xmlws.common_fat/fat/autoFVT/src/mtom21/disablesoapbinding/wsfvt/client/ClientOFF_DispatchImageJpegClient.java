//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/ClientOFF_DispatchImageJpegClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:14 [8/8/12 06:40:46]
//
 ...
 * client. - service has MTOM = OFF with SOAP11 - exclusively disables MTOM using
 * binding.setMTOMEnabled(false);
 */

public class ClientOFF_DispatchImageJpegClient {
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DispatchImageJpegClient.JAXB_AttachmentSmallJpeg() ***\n");
    ...
    public String JAXB_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DispatchImageJpegClient.JAXB_AttachmentLargeJpeg() ***\n");
