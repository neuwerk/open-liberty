//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/DispatchImageJpegClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:27 [8/8/12 06:40:46]
//
...
/**
 * This testcase uses a JAXB generated objects This testcase covers the "image/jpeg" MIME type using
 * Dispatch. The service has MTOM disabled with SOAP11, and client with MTOM setting as default
 * (bindingID = null).
 */
...
public class DispatchImageJpegClient {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "DisableSBJAXBImageJpegService");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablesoapbinding21/DisableSBJAXBImageJpegService";
     ...
     *  - sends small image (12K) - uses no setting for MTOM from client (bindingID = null) - mode =
     * PAYLOAD - no setting for SOAP version
     * 
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        try {
            ...
            JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.disablesb_imagejpeg");
     ...
     * This testcase uses a JAXWS Dispatch invocation with JAXB generated request object as
     * parameter. The endpoint for these testcase is a JAXWS Source Provider.
     *  - sends an image (68K) - uses no setting for MTOM from client (bindingID = null) - mode =
     * PAYLOAD - no setting for SOAP version
     * 
     * @return returned from the remote method
     */
