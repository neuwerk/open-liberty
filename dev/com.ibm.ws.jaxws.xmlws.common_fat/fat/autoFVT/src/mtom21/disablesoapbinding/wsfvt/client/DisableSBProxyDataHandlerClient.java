//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/DisableSBProxyDataHandlerClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:20 [8/8/12 06:40:46]
//
 ...
 * using Proxy. Sevice has MTOM=OFF Client has MTOM=default (no setting for MTOM)
 */

public class DisableSBProxyDataHandlerClient {
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DisableSBProxyDataHandlerClient.Proxy_AttachmentSmallJpeg ***\n");
