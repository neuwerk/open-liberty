//
// @(#) 1.1 autoFVT/src/mtom21/disablesoapbinding/wsfvt/client/ClientOFF_DisableSBProxyDataHandlerSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:28:11 [8/8/12 06:40:46]
//
...
/**
 * This testcase uses a JAXB generated objects. - covers the "multipart/*" mime types, using Proxy
 * client. - service has MTOM = OFF with SOAP12 - exclusively disables MTOM using
 * binding.setMTOMEnabled(false);
 */

public class ClientOFF_DisableSBProxyDataHandlerSOAP12Client {
    ...
    public static final QName serviceName = new QName("http://org/test/mtom21/DisableSBProxySOAP12_datahandler",
            "DisableSBProxyDataHandlerSOAP12Service");
    public static final QName portName = new QName("http://org/test/mtom21/DisableSBProxySOAP12_datahandler",
            "AttachmentServicePort");
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/disablesoapbinding21/DisableSBProxyDataHandlerSOAP12Service";
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxyDataHandlerSOAP12Client.Proxy_AttachmentSmallJpeg ***\n");
    ...
    public String Proxy_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In ClientOFF_DisableSBProxyDataHandlerSOAP12Client.Proxy_AttachmentLargeJpeg ***\n");
