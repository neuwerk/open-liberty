//
// @(#) 1.1 autoFVT/src/mtom21/enablesoapbinding/wsfvt/client/EnableSBProxyDataHandlerClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:33:29 [8/8/12 06:40:53]
//
 ...
 * Sevice has MTOM=ON
 * Client has MTOM=default (no setting for MTOM)
 */


public class EnableSBProxyDataHandlerClient {
    ...
    public static final QName serviceName = new QName("http://ws.apache.org/axis2", "EnableSBProxyDataHandlerService");
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/enablesoapbinding21/EnableSBProxyDataHandlerService";
    ...
    public String proxy_AttachmentSmallJpeg_VerifyMTOM() throws Exception {
        ...
        SOAPBodyElement payload = body.addBodyElement(new QName("http://org/test/mtom21/EnableSBProxy_datahandler", "sendImage"));
    ...
    public String Proxy_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In EnableSBProxyDataHandlerClient.Proxy_AttachmentSmallJpeg ***\n");
