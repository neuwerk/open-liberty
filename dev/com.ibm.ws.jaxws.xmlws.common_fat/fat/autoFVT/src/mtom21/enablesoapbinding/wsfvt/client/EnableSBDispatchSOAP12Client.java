//
// @(#) 1.1 autoFVT/src/mtom21/enablesoapbinding/wsfvt/client/EnableSBDispatchSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/15/08 14:33:26 [8/8/12 06:40:53]
//
 ...
 * using Dispatch client to send a message.
 * Server has MTOM = ON with SOAP12
 * client has MTOM = OFF using bindingID =  SOAPBinding.SOAP12HTTP_BINDING;
*/


public class EnableSBDispatchSOAP12Client {
    ...
    QName serviceName = new QName("http://ws.apache.org/axis2", "EnableSBJAXBImageJpegSOAP12Service");
    QName portName = new QName("http://ws.apache.org/axis2", "AttachmentServicePort");

    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
            + "@REPLACE_WITH_PORT_NUM@/enablesoapbinding21/EnableSBJAXBImageJpegSOAP12Service";
    ...
    public static void main(String[] args) {
        try {
            ...
            client.jaxb_AttachmentSmallJpeg_VerifyMTOM();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public String jaxb_AttachmentSmallJpeg_VerifyMTOM() throws Exception {
        ...
        SOAPBodyElement payload = body.addBodyElement(new QName("urn://EnableSB_imagejpegSOAP12.mtom21.test.org", "invoke"));
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DispatchImageJpegSOAP12Client.JAXB_AttachmentSmallJpeg() ***\n");
        ...
        try {
            ...
            JAXBContext jbc = JAXBContext.newInstance("org.test.mtom21.enablesb_imagejpegsoap12");
    ...
    public String JAXB_AttachmentLargeJpeg() throws Exception {
        ...
        // debug
        System.out.println("\n*** In DispatchImageJpegSOAP12Client.JAXB_AttachmentLargeJpeg() ***\n");
