//
// @(#) 1.3 autoFVT/src/mtom/security/wsfvt/server/SecurityMtomOffProxyService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/31/07 16:57:52 [8/8/12 06:58:18]
//
...
@WebService(
		targetNamespace = "http://org/test/mtom/SecurityMtomOffProxy",
		serviceName = "SecurityMtomOffProxyService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/SecurityMtomOffProxy.wsdl",
		endpointInterface = "org.test.mtom.securitymtomoffproxy.ImageServiceInterface")
