//
// @(#) 1.10 autoFVT/src/mtom/security/wsfvt/client/ClientOFF_Security_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 10/23/07 15:14:21 [8/8/12 06:58:19]
//
...
// 02/13/07 jtnguyen    420519          Changed port # to @REPLACE_WITH_PORT_NUM_SECURE@
...
public class ClientOFF_Security_ProxySOAP12Client {
    ...
    public static void main(String[] args) throws Exception {
      ...
      *   Server has MTOM = Enabled with SOAP12
    ...
    public String Proxy_AttachmentLargeJpeg()  {
   	   ...
   	   System.out.println("\n*** In ClientOFF_Security_ProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");  	   
