//
// @(#) 1.10 autoFVT/src/mtom/security/wsfvt/client/ClientOFF_ServerOFF_Security_ProxyClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 10/23/07 15:14:09 [8/8/12 06:58:18]
//
...
// 04/26/07 ulbricht    432145          Fix compile failure
...
import org.test.mtom.securitymtomoffproxy.*;  
...
public class ClientOFF_ServerOFF_Security_ProxyClient {
    ...
    String endpointUrl = "https://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM_SECURE@/security/SecurityMtomOffProxyService";
    ...
    public String Proxy_AttachmentLargeJpeg(){
   	   ...
   	   System.out.println("\n*** In ClientOFF_ServerOFF_Security_ProxyClient.Proxy_AttachmentLargeJpeg ***\n");  	   
