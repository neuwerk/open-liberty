//
// @(#) 1.10 autoFVT/src/mtom/security/wsfvt/client/ClientOFF_ServerOFF_Security_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 10/23/07 15:14:11 [8/8/12 06:58:18]
//
...
import org.test.mtom.securitymtomoffproxysoap12.*;  
...
public class ClientOFF_ServerOFF_Security_ProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom/SecurityMtomOffProxySOAP12", "SecurityMtomOffProxySOAP12Service");
    QName portName    = new QName("http://org/test/mtom/SecurityMtomOffProxySOAP12", "AttachmentServicePort");


    String endpointUrl = "https://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM_SECURE@/security/SecurityMtomOffProxySOAP12Service";

    String http_endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/security/SecurityMtomOffProxySOAP12Service";
     ...
     *   Server has MTOM = Disabled with SOAP12
     *   Client has MTOM = Disabled     
     *   Service Mode = payload
     */

    public String Proxy_AttachmentLargeJpeg() {
    	
   	   System.out.println("\n*** In ClientOFF_ServerOFF_Security_ProxySOAP12Client.Proxy_AttachmentLargeJpeg ***\n");  	   
