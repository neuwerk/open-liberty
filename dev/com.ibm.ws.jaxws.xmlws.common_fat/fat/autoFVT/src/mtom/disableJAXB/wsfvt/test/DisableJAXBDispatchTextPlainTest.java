//
// @(#) 1.2 autoFVT/src/mtom/disableJAXB/wsfvt/test/DisableJAXBDispatchTextPlainTest.java, WAS.websvcs.fvt, WASX.FVT 1/26/07 13:45:52 [7/11/07 13:17:53]
//
 ...
 * 
 */
public class DisableJAXBDispatchTextPlainTest extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
    ...
    public void testDispatch_ServerDefault_ClientOFF_plaintextMIME_ShortString() {
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testDispatch_ServerDefault_ClientOFF_plaintextMIME_LongString() {
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testDispatch_ServerDefault_ClientOFF_plaintextMIME_FromXMLFile() {
