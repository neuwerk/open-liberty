//
// @(#) 1.2 autoFVT/src/mtom/disableJAXB/wsfvt/client/DisableJAXBProxyImageJpegClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/23/07 10:43:30 [8/8/12 06:58:04]
//
 ...
 * MTOM is disabled in this client.  Service has default setting for MTOM,
...
public class DisableJAXBProxyImageJpegClient {
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/disablejaxb/MTOMDefaultProxyImageJpegService";
    //String bindingID = SOAPBinding.SOAP11HTTP_MTOM_BINDING;  // not supported yet 9/20/06
