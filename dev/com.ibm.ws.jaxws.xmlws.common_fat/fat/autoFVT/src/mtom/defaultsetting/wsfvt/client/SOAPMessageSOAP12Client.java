//
// @(#) 1.4 autoFVT/src/mtom/defaultsetting/wsfvt/client/SOAPMessageSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 5/16/07 14:56:48 [8/8/12 06:58:20]
//
...
// 05/10/07 jtnguyen    438387          Fixed failure in iSeries for null message
...
public class SOAPMessageSOAP12Client {
	...
	public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
          + "@REPLACE_WITH_PORT_NUM@/mtomdefaultsetting/ProviderSOAPMessageSOAP12Service";
	   
	public static final String bindingID = SOAPBinding.SOAP12HTTP_BINDING;
    ...
    public String DefaultSetting_SOAPMessage_TextMessage() {
        ...
        System.out.println("\n***** In SOAPMessageSOAP12Client.DefaultSetting_SOAPMessage_TextMessage *****\n"); 	      
        ...
        ((BindingProvider)dispatch).getRequestContext().put(BindingProvider.SOAPACTION_URI_PROPERTY, "echoString");
         ...
         System.out.println("Sending message:\"" + orgSrc +"\"");
    ...
    */
    ...
    public String DefaultSetting_SOAPMessage_ImageMessage() {
        ...
        System.out.println("\n***** In SOAPMessageSOAP12Client.DefaultSetting_SOAPMessage_ImageMessage *****\n");
    ...
    public String compare(String s, String orgSrc){
        ...
        if (s != null) {
            ...
            String s3 = xmlHeader + orgSrc;   // expected message
            if (s2.equals(s3)){  
                System.out.println("Message received as expected.");
