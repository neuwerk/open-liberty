//
// @(#) 1.2 autoFVT/src/mtom/defaultsetting/wsfvt/server/ProviderSOAPMessageService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 5/16/07 14:56:50 [8/8/12 06:58:23]
//
...
/**
* This service receives a SOAPMessage object and return it back to client
*
* @param SOAPMessage object
...
*/
  ...
  public SOAPMessage invoke(SOAPMessage obj) {
      System.out.println("--------------------------------------");
      System.out.println("defaultsetting - ProviderSOAPMessageService: Request received");
     ...
     try {
		...
		if (s != null) {
			  ...
			  String s2 = s.replaceAll(inHeader,outHeader);			  
                          ...
                          badResult = "***ERROR at Service Endpoint: Received message does not have inHeader.  See WAS systemOut.log for details.";
                          System.out.println(badResult);
		  	  retVal = Common.toSOAPMessage(head + badResult + tail);
		   }
		}
                else {   
                    badResult = "***ERROR at Service Endpoint: Received message is NULL.";
                    System.out.println(badResult);
                    retVal = Common.toSOAPMessage(head + badResult + tail);
                } 
		   ...
		   System.out.println("***ERROR - ProviderSOAPMessageService: Failed at service endpoint.");	
		   ex.printStackTrace();     
