//
// @(#) 1.4 autoFVT/src/mtom/enableSOAPBinding/wsfvt/client/EnableSBDispatchSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:18 [8/8/12 06:58:15]
//
...
public class EnableSBDispatchSOAP12Client {
	...
	String jpegOptimizedFilename3 = "image3Expected.jpeg";
       ...
       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/enablesoapbinding/EnableSBJAXBImageJpegSOAP12Service";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
  	  ...
  	  System.out.println("portname = " + portName 
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.enablesb_imagejpegsoap12");
