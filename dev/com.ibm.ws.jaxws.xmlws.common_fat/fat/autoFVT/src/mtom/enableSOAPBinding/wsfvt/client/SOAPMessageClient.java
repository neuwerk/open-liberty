//
// @(#) 1.3 autoFVT/src/mtom/enableSOAPBinding/wsfvt/client/SOAPMessageClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 5/16/07 14:57:02 [8/8/12 06:58:22]
//
...
import mtom.enableSOAPBinding.wsfvt.client.Common;

/*
 * Message sent/received must use correct header/footer as defined in wsdl
 * - MTOM is disabled (a default) on the client and enabled on the service end point
 * - mode = Message
...
public class SOAPMessageClient {
	...
	public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
          + "@REPLACE_WITH_PORT_NUM@/enablesoapbinding/ProviderSOAPMessageService";
