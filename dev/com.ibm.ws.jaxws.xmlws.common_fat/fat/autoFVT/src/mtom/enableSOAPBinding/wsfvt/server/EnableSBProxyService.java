//
// @(#) 1.3 autoFVT/src/mtom/enableSOAPBinding/wsfvt/server/EnableSBProxyService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/31/07 16:57:26 [8/8/12 06:58:16]
//
...
import org.test.mtom.enablesb_proxy.*;

@WebService(
		targetNamespace = "http://org/test/mtom/EnableSB_proxy",
		serviceName = "EnableSBProxyService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/EnableSBProxy.wsdl",
		endpointInterface = "org.test.mtom.enablesb_proxy.EnableSBProxyInterface")
...
public class EnableSBProxyService implements EnableSBProxyInterface {
	
	/* 
	 */
	public ImageDepot sendImage(ImageDepot input) {
        System.out.println("---------------------------------------");
		System.out.println("EnableSBProxyService - sendImage method: Request received");
		return input;
	}
	...
	public ImageDepot sendText(byte[] input) {
        System.out.println("---------------------------------------");
		System.out.println("EnableSBProxyService - sendText method: Request received");
