//
// @(#) 1.4 autoFVT/src/mtom/mixedsetting/wsfvt/client/ClientON_MixedSetting_DispatchSOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:35 [8/8/12 06:58:12]
//
...
// 11/21/06 jtnguyen    407277          Fixed MTOM=on or off correctly
...
import org.test.mtom.mtomoffdispatchsoap12.*;
...
public class ClientON_MixedSetting_DispatchSOAP12Client {
	...
	String jpegOptimizedFilename3 = "image3Expected.jpeg";
       ...
       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting/MtomOffDispatchSOAP12Service";
    ...
    public String JAXB_AttachmentSmallJpeg_SOAP12() throws Exception {
  	  ...
  	  System.out.println("portname = " + portName 
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.mtomoffdispatchsoap12");
