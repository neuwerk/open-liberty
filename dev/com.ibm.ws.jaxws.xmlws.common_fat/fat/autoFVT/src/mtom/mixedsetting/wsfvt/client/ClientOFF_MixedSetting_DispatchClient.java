//
// @(#) 1.3 autoFVT/src/mtom/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_DispatchClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:25 [8/8/12 06:58:12]
//
...
import org.test.mtom.mtomondispatch.*;  // MtomOnDispatch - same name with service
...
public class ClientOFF_MixedSetting_DispatchClient {
	...
	String jpegOptimizedFilename3 = "image3Expected.jpeg";
       ...
       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting/MtomOnDispatchService";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
  	  ...
  	  System.out.println("portname = " + portName 
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.mtomondispatch");
