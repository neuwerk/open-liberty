//
// @(#) 1.3 autoFVT/src/mtom/mixedsetting/wsfvt/client/ClientOFF_MixedSetting_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:30 [8/8/12 06:58:12]
//
...
import org.test.mtom.mtomonproxysoap12.*;
...
public class ClientOFF_MixedSetting_ProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom/MtomOnProxySOAP12", "MtomOnProxySOAP12Service");
    QName portName    = new QName("http://org/test/mtom/MtomOnProxySOAP12", "AttachmentServicePort");


    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting/MtomOnProxySOAP12Service";
     ...
     * Server has MTOM set to ON with SOAP12
     * Sends an XML file
     */
