//
// @(#) 1.3 autoFVT/src/mtom/mixedsetting/wsfvt/client/ClientON_MixedSetting_DispatchClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:33 [8/8/12 06:58:12]
//
...
public class ClientON_MixedSetting_DispatchClient {
	...
	String jpegOptimizedFilename3 = "image3Expected.jpeg";
       ...
       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting/MtomOffDispatchService";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
  	  ...
  	  System.out.println("portname = " + portName 
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.mtomoffdispatch");
