//
// @(#) 1.3 autoFVT/src/mtom/mixedsetting/wsfvt/server/MtomOffProxyService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/31/07 16:57:37 [8/8/12 06:58:13]
//
...
import org.test.mtom.mtomoffproxy.*;

@WebService(
		targetNamespace = "http://org/test/mtom/MtomOffProxy",
		serviceName = "MtomOffProxyService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/MtomOffProxy.wsdl",
		endpointInterface = "org.test.mtom.mtomoffproxy.ImageServiceInterface")
