//
// @(#) 1.3 autoFVT/src/mtom/mixedsetting/wsfvt/client/ClientON_MixedSetting_ProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:39 [8/8/12 06:58:12]
//
...
import org.test.mtom.mtomoffproxysoap12.*;  // mtomoffproxysoap12 - same as service
...
public class ClientON_MixedSetting_ProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom/MtomOffProxySOAP12", "MtomOffProxySOAP12Service");
    QName portName    = new QName("http://org/test/mtom/MtomOffProxySOAP12", "AttachmentServicePort");


    String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/mtommixedsetting/MtomOffProxySOAP12Service";
     ...
     * Server has MTOM set to OFF with SOAP12
