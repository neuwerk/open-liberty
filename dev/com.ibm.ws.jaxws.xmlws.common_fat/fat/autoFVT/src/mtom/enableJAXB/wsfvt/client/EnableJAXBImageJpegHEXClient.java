//
// @(#) 1.4 autoFVT/src/mtom/enableJAXB/wsfvt/client/EnableJAXBImageJpegHEXClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:40:07 [8/8/12 06:58:19]
//
...
/**
 * This testcase uses a JAXB generated objects for binary type = hexBinary.
...
public class EnableJAXBImageJpegHEXClient {
    ...
    public static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/enablejaxb/EnableJAXBImageJpegHEXService";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
       ...
       String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.enablejaxb_imagejpeghex");
