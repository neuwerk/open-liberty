//
// @(#) 1.2 autoFVT/src/mtom/enableJAXB/wsfvt/test/JAXBMTOMBindingTest.java, WAS.websvcs.fvt, WASX.FVT 2/25/07 20:40:16 [7/11/07 13:18:24]
//
...
public class JAXBMTOMBindingTest extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
    ...
    public void testDispatch_ServerDefault_MTOMBindingClientONSOAP11_ImageJpegMIME_SmallJpeg() {
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testDispatch_ServerDefault_MTOMBindingClientONSOAP11_ImageJpegMIME_LargeJpeg() {
