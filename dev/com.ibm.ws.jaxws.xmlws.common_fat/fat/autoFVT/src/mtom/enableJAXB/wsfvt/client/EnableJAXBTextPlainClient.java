...
// 11/21/06 jtnguyen    407277          Removed bad character to be able to build on Linux
...
public class EnableJAXBTextPlainClient {
   ...
   private static final String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/enablejaxb/EnableJAXBTextPlainService";
   private static final Service.Mode mode = Service.Mode.PAYLOAD;
    ...
    public String JAXB_AttachmentShortString() throws Exception {
       ...
       String bindingID = SOAPBinding.SOAP11HTTP_BINDING;
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.enablejaxb_textplain");
