//
// @(#) 1.2 autoFVT/src/mtom/enableJAXB/wsfvt/test/JAXBImageJpegTest.java, WAS.websvcs.fvt, WASX.FVT 2/25/07 20:40:14 [7/11/07 13:18:24]
//
...
public class JAXBImageJpegTest extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
    ...
    public void testDispatch_ServerDefault_ClientONSOAP11_ImageJpegMIME_SmallJpeg() {
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testDispatch_ServerDefault_ClientONSOAP11_ImageJpegMIME_LargeJpeg() {
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
   public void testDispatch_ServerDefault_ClientONSOAP11_ImageJpegMIME_Sequence_SmallJpeg() {
