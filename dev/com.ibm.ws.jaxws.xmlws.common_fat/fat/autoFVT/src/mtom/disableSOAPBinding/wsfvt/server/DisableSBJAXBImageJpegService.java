//
// @(#) 1.4 autoFVT/src/mtom/disableSOAPBinding/wsfvt/server/DisableSBJAXBImageJpegService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 4/9/07 22:24:40 [8/8/12 06:58:08]
//
...
@WebService(
		targetNamespace = "urn://DisableSB_imagejpeg.mtom.test.org",
		serviceName = "DisableSBJAXBImageJpegService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/JAXBImageJpeg.wsdl",
		endpointInterface = "org.test.mtom.disablesb_imagejpeg.ImageServiceInterface")
