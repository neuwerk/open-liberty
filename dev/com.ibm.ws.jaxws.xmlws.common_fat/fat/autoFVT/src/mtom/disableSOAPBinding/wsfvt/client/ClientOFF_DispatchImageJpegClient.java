//
// @(#) 1.3 autoFVT/src/mtom/disableSOAPBinding/wsfvt/client/ClientOFF_DispatchImageJpegClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:39:51 [8/8/12 06:58:07]
//
...
public class ClientOFF_DispatchImageJpegClient {
	...
	String jpegOptimizedFilename3 = "image3Expected.jpeg";
       ...
       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/disablesoapbinding/DisableSBJAXBImageJpegService";
    ...
    public String JAXB_AttachmentSmallJpeg() throws Exception {
  	  ...
  	  System.out.println("portname = " + portName 
         ...
         JAXBContext jbc = JAXBContext.newInstance("org.test.mtom.disablesb_imagejpeg");
