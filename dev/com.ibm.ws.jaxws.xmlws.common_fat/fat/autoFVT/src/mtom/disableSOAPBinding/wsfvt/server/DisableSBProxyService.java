//
// @(#) 1.3 autoFVT/src/mtom/disableSOAPBinding/wsfvt/server/DisableSBProxyService.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/31/07 16:57:03 [8/8/12 06:58:08]
//
...
@WebService(
		targetNamespace = "http://org/test/mtom/DisableSB_proxy",
		serviceName = "DisableSBProxyService",
		portName = "AttachmentServicePort",		
		wsdlLocation = "WEB-INF/wsdl/DisableSBProxy.wsdl",
		endpointInterface = "org.test.mtom.disablesb_proxy.ImageServiceInterface")
