//
// @(#) 1.3 autoFVT/src/mtom/disableSOAPBinding/wsfvt/client/ClientOFF_DisableSBProxySOAP12Client.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 2/25/07 20:38:46 [8/8/12 06:58:07]
//
...
import org.test.mtom.disablesb_proxysoap12.*;

/**
 * This testcase uses a JAXB generated objects.
 * - covers the ""image/jpeg"  MIME types, using Proxy client to send a message as dataHandler object.
...
public class ClientOFF_DisableSBProxySOAP12Client {
    ...
    QName serviceName = new QName("http://org/test/mtom/DisableSB_proxySOAP12", "DisableSBProxySOAP12Service");
    QName portName    = new QName("http://org/test/mtom/DisableSB_proxySOAP12", "AttachmentServicePort");


       String endpointUrl = "http://@REPLACE_WITH_HOST_NAME@:"
                          + "@REPLACE_WITH_PORT_NUM@/disablesoapbinding/DisableSBProxySOAP12Service";
