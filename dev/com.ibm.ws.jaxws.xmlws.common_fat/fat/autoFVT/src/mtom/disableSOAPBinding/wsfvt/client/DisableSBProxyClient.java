//
// @(#) 1.2 autoFVT/src/mtom/disableSOAPBinding/wsfvt/client/DisableSBProxyClient.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 1/23/07 10:44:13 [8/8/12 06:58:08]
//
...
public class DisableSBProxyClient {
	 ...
	 * as parameter. 
	 * 
	 * - Service has MTOM disabled with SOAP11
	 ...
	 * This testcase uses a JAXWS Proxy with JAXB generated request object
	 * as parameter. 
	 * - Sends a text read from a text file
	 * - Service has MTOM disabled with SOAP11
	 * - sends small image (12K)
     * - uses no setting for MTOM from client
     * - mode = PAYLOAD
