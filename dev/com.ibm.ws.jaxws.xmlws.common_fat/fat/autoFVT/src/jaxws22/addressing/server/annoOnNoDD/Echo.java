...
public class Echo {
    ...
    public String echo(String in) throws java.lang.Exception {
        System.out.println("annoOnNoDD echo called with arg:" +in);
        // send back the request headers if asked for them
        // this is an undocumented an unsupported use of the handler extensions FIS that
        // allows direct access to headers.  It's not supported in an impl but it works.  
