//
// @(#) 1.1 autoFVT/src/jaxws22/mtom/test/MtomJsr224v22FactoryMethodsTest.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 8/2/10 11:50:37 [8/8/12 06:57:48]
//
...
//import jaxws22.mtom.client.com.test.*;
import jaxws22.mtom.client.*;  
import jaxws22.mtom.client.CommonMTOMClient;
import jaxws22.mtom.client.MTOMDDOnlyIF;
import jaxws22.mtom.client.MessageCaptureHandler;
...
public class MtomJsr224v22FactoryMethodsTest extends FVTTestCase {   
    ...
    public void testStaticCreate1arg()throws Exception{
      try{  
        jaxws22.mtom.client.MTOMDDOnlyService s =
             new jaxws22.mtom.client.MTOMDDOnlyService(new MTOMFeature(true, 64));
      } catch (WebServiceException e){
          System.out.println("caught expected exception:");
          e.printStackTrace(System.out);
          return;
    ...
    public void testStaticCreate1argRespectBinding()throws Exception{
        try{  
          jaxws22.mtom.client.MTOMDDOnlyService s =
               new jaxws22.mtom.client.MTOMDDOnlyService(new RespectBindingFeature(true));
        } catch (WebServiceException e){
            System.out.println("caught expected exception:");
            e.printStackTrace(System.out);
            return;
    ...
    public void testStaticCreate2arg()throws Exception{
        ...
        try{  
            jaxws22.mtom.client.MTOMDDOnlyService s =
                 new jaxws22.mtom.client.MTOMDDOnlyService(u, new MTOMFeature(true, 64));
          } catch (WebServiceException e){
              System.out.println("caught expected exception:");
              e.printStackTrace(System.out);
              return;
    ...
    public void testStaticCreate2argAddressing()throws Exception{
        ...
        try{  
            jaxws22.mtom.client.MTOMDDOnlyService s =
                 new jaxws22.mtom.client.MTOMDDOnlyService(u, new AddressingFeature(true));
          } catch (WebServiceException e){
              System.out.println("caught expected exception:");
              e.printStackTrace(System.out);
              return;
    ...
    public void testStaticCreate2argqmarkwsdl()throws Exception{
        URL u = new URL( hostAndPort+"/"+ "webservicefeaturetests/MTOMDDOnlyService?wsdl");    
            jaxws22.mtom.client.MTOMDDOnlyService s =
                 new jaxws22.mtom.client.MTOMDDOnlyService(u);
    ...
    public void testStaticCreate3arg()throws Exception{
        ...
        try{  
            jaxws22.mtom.client.MTOMDDOnlyService s =
                 new jaxws22.mtom.client.MTOMDDOnlyService(u, q, new MTOMFeature(true, 64));
          } catch (WebServiceException e){
              System.out.println("caught expected exception:");
              e.printStackTrace(System.out);
              return;
    ...
    public void testStaticGetPort2arg()throws Exception{
        ...
        QName q = new QName("http://test.com/", "MTOMDDOnlyService");      
        jaxws22.mtom.client.MTOMDDOnlyService s =
             new jaxws22.mtom.client.MTOMDDOnlyService(u, q);
    ...
    */
    ...
    public void testDispatchWithJAXBContext() throws Exception {
        ...
        JAXBContext context = JAXBContext.newInstance(new Class[] {
                jaxws22.mtom.client.ObjectFactory.class });
