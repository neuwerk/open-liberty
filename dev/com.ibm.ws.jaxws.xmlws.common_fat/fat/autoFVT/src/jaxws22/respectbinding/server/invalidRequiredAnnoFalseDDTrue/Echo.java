...
@RespectBinding(enabled=false)  // should default to enabled, we'll find out. 
@WebService(wsdlLocation="WEB-INF/wsdl/EchoService.wsdl")
public class Echo {
    public String echo(String in) throws Exception {
        System.out.println("Respect Binding invalidRequiredAnnoFalseDDTrue echo called with arg:" +in);
        return in;
    }
}
