 ...
 *
 */
@WebService(wsdlLocation="WEB-INF/wsdl/WebParamGeneralChecksService.wsdl")
public class WebParamGeneralChecks {
    
    // just for debug
    private String whatChanged="the_header"; 
	/**
	...
	@WebMethod public Object echoObject7 (@WebParam(name="obj", header=false) Object o){
		return o;
	}
