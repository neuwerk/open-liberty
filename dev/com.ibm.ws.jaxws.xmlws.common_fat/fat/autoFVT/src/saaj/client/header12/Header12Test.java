...
/**
  ...
  *     saaj/server/com.ibm.wsfp.jaxws_1.0.0.jar/...../Header12Response.java
  *
  */
public class Header12Test extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
    
    public Header12Test(String name) {
        super(name);
    }
    ...
    public void testHeader12_1() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_1() No SOAPHeader--------");
    ...
    private SOAPMessage createRequest1Msg() throws Exception{
        ...
        Name bodyName           = soapFactory.createName("Header12_1",
                                                         "n12", "http://saaj.ibm.com/n12");
        SOAPBodyElement soapBodyElement = soapBody.addBodyElement( bodyName );
        soapBodyElement.addTextNode( "testHeader12:Header12_1" );
    ...
    private void verifyHeader1Message( SOAPMessage response ) throws Exception{
        ...
        assertTrue( "localName expects 'Header12' but get '" +
                    strLocalName + "'",
                    strLocalName.equals( "Header12" ) );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_2() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_2() two SOAPHeaderElement --------");
    ...
    private SOAPMessage createRequest2Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_2", "home", "http://northernstar.org/h2");
        SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.setActor( "Header12_2" );
        ...
        Name        headerName1  = soapFactory.createName("Header12_2_1", "mustHave", 
                                                          "http://lyqs.austin.ibm.com/saaj/headernn");
        SOAPHeaderElement soapHeaderElem1 = soapHeader.addHeaderElement( headerName1 );
        soapHeaderElem1.setActor(SOAPConstants.URI_SOAP_ACTOR_NEXT );  
                               // 1_1 must changed SOAPConstants.URI_SOAP_1_2_ROLE_NEXT
        soapHeaderElem1.setMustUnderstand( true ); 
        soapHeaderElem1.addTextNode( "Header12 2 1" );

        Name bodyName           = soapFactory.createName("Header12_2",
                                                         "n12", "http://saaj.ibm.com/n12");
        SOAPBodyElement soapBodyElement = soapBody.addBodyElement( bodyName );
        soapBodyElement.addTextNode( "headerBody12_2_text" );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_3() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_3() one SOAPHeaderElement --------");
    ...
    private SOAPMessage createRequest3Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_3", "", "http://northernstar.org/h3");
        SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.setActor( "Header12_3" );
        soapHeaderElem.setMustUnderstand( false );
        soapHeaderElem.addTextNode( "Header12 3 3" );

        soapBody.addNamespaceDeclaration( "h12", "http://AirForceNumberOne.edu.us/Boeing747" );
        SOAPBodyElement soapBodyElement = (SOAPBodyElement)soapBody.addChildElement( "Header12_3", "h12" );
    ...
    private void verifyHeader3Message( SOAPMessage response ) throws Exception{
        ...
        Name name = soapHeaderElem.getElementName();
        String strLocalName = name.getLocalName();
        assertTrue( "localName expects 'Header12_3' but get '" +
                    strLocalName + "'",
                    strLocalName.equals( "Header12_3" ) );
        ...
        String strWS   = soapHeaderElem.getAttributeValue( attrName );
        assertTrue( "The Attribute Value of attrib12_3 expects 'attribute 123' but get '" +
                    strWS + "'",
                    strWS.equals( "attribute 123" )
                  );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_4() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_4() two SOAPHeaderElement --------");
    ...
    private SOAPMessage createRequest4Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_4", 
                                                          "mn", 
                                                          "http://musthave.namespace.com/headerElement" );
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.addTextNode( "Header12_4" );

        Name        headerName1  = soapFactory.createName("Header12_4_1",
                                                          "mn", 
                                                          "http://musthave.namespace.com/headerElement" );
        SOAPHeaderElement soapHeaderElem1 = soapHeader.addHeaderElement( headerName1 );
        soapHeaderElem1.addTextNode( "Header12 4 1" );

        Name bodyName           = soapFactory.createName("Header12_4",
                                                          "mn", 
                                                          "http://musthave.namespace.com/headerElement" );
        SOAPBodyElement soapBodyElement = soapBody.addBodyElement( bodyName );
        soapBodyElement.addTextNode( "Header12_4_text" );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_5() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_5() two SOAPHeaderElement --------");
    ...
    private SOAPMessage createRequest5Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_5", 
                                                         "", 
                                                         "http://default.ibm.com/default" );
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.addTextNode( "Header12_5" );

        Name        headerName1  = soapFactory.createName("Header12_5_1",
                                                          "", 
                                                          "http://default.ibm.com/default" );
        SOAPHeaderElement soapHeaderElem1 = soapHeader.addHeaderElement( headerName1 );
        soapHeaderElem1.addTextNode( "Header12 5 1" );

        Name        headerName2  = soapFactory.createName("Header12_5_2",
                                                          "", 
                                                          "http://default.ibm.com/default" );
        SOAPHeaderElement soapHeaderElem2 = soapHeader.addHeaderElement( headerName2 );
        soapHeaderElem2.addTextNode( "Header12 5 2" );

        Name bodyName           = soapFactory.createName("Header12_5", "",
                                                         "http://default.ibm.com/default" );
        SOAPBodyElement soapBodyElement = soapBody.addBodyElement( bodyName );
        soapBodyElement.addTextNode( "Header12_5_text" );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_6() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_6() one SOAPHeaderElement --------");
    ...
    private SOAPMessage createRequest6Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_6", "envX", "http://www.austin.texas/ibm" );
        SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.setActor( "Header12_6" );
        soapHeaderElem.setMustUnderstand( false );
        soapHeaderElem.addTextNode( "Header12 6 6" );

        soapBody.addNamespaceDeclaration( "h12", "http://AirForceNumberOne.edu.us/Boeing747" );
        SOAPBodyElement soapBodyElement = (SOAPBodyElement)soapBody.addChildElement( "Header12_6", "h12" );
        soapBodyElement.addTextNode( "Boeing 747 is a giant airplane" );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_7() throws Exception {
        System.out.println( "------------- testHeader12_7------------" );
        ...
        try{
            Name        headerName  = soapFactory.createName("Header12_7" );
            SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
            SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_8() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_8() sending a 10K-long String --------");
    ...
    private SOAPMessage createRequest8Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_8", "envX", "http://www.austin.texas/ibm" );
        SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.setActor( "Header12_8" );
        soapHeaderElem.setMustUnderstand( false );
        soapHeaderElem.addTextNode( "Header12 8 8" );

        soapBody.addNamespaceDeclaration( "long", "http://ut.edu.us/longhorn" );
        SOAPBodyElement soapBodyElement = (SOAPBodyElement)soapBody.addChildElement( "Header12_8", "long" );
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testHeader12_9() throws Exception {
        System.out.println( );
        System.out.println("------------testHeader12_9()sending 50 attributes --------");
    ...
    private SOAPMessage createRequest9Msg() throws Exception{
        ...
        Name        headerName  = soapFactory.createName("Header12_9", "env50", "http://www.austin.texas/attibute50" );
        SOAPHeader  soapHeader  = soapMessage .getSOAPHeader();
        SOAPHeaderElement soapHeaderElem = soapHeader.addHeaderElement( headerName );
        soapHeaderElem.setActor( "Header12_9" );
        soapHeaderElem.setMustUnderstand( false );
        soapHeaderElem.addTextNode( "testing 50 attributes" );

        soapBody.addNamespaceDeclaration( "lotsOfAttributes", "http://ut.edu.us/lotsof" );
        SOAPBodyElement soapBodyElement = (SOAPBodyElement)soapBody.addChildElement( "Header12_9", "lotsOfAttributes" );
        soapBodyElement.addTextNode( "51 attributes" );
        SAAJHelper.addAttribute( soapBodyElement, 12 );
        return soapMessage; 
    }
    ...
    private void verifyHeader9Message( SOAPMessage response ) throws Exception{
        ...
        assertTrue( "Did not get back the expected 51 attributes ",
                    SAAJHelper.verifyAttribute( soapBodyElement, 12 ) );
    }
