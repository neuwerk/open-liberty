 ...
 *
 */
public class SOAPMessage13Helper extends SAAJHelper {
    ...
    static String endpointUrl  = "http://" + server.getMachine().getHostname() +
                                 ...
                                 // ":19080" +                     // For tcpmon
                                 "/soapmessagefvt/SOAPMessage13Service";
                                // "/soapmessagefvt/services/SOAPMessage13Service";

    private static QName serviceQName = new QName("http://saaj.server/soapmessage", "SOAPMessage13Service");
    ...
    public static SOAPMessage send( SOAPMessage request, boolean bPrint) throws Exception{
        ...
        try{       
            ...
            if( bPrint){
                System.out.println("Request 13 Message:");
            ...
            // Dispatch
            System.out.println(">> Invoking SOAPMessage13ProviderDispatch");
            response = dispatch.invoke(request);

            System.out.println(">> Response 13 [" + response.toString() + "]");
    ...
    public static SOAPMessage sendAttachmentMTOM( SOAPMessage request ) throws Exception{
        // TODO: This needs to have special handling in SOAPMessag13Provider
        SOAPMessage response = null;
        try{       
            // Create the dispatch
            Dispatch<SOAPMessage> dispatch = createDispatch();
            ...
            System.out.println("Request 13 MTOM Message:");
            request.writeTo(System.out);
            ...
            System.out.println(">> Response 13 MTOM [" + response.toString() + "]");
            response.writeTo(System.out);
