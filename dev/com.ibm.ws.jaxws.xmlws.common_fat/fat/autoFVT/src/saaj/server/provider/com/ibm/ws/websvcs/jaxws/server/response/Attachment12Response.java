...
/**
 * Attachment12Response
 * 
 * response to the\ saaj.ient.test.Attachment12Test
 * This will only deal with Body Elements
 *
 */

public class Attachment12Response extends com.ibm.ws.saaj.SAAJUtil
{
    ...
    public static  SOAPMessage test( MessageContext msgCtx, SOAPMessage soapMessage ) 
        ...
        if( soapHeaderElem != null ){
            ...
            if( strActor.equals( "Attachment12_2" ) ){
                return answerAttachment12Message2( soapMessage );
            } else  if( strActor.equals( "Attachment12_3" ) ){
                return answerAttachment12Message3( soapMessage );
            } else  if( strActor.equals( "Attachment12_4" ) ){
                return answerAttachment12Message4( soapMessage );
            } else  if( strActor.equals( "Attachment12_5" ) ){
                return answerAttachment12Message5( soapMessage );
            } else  if( strActor.equals( "Attachment12_6" ) ){
                return answerAttachment12Message6( soapMessage );
            } else  if( strActor.equals( "Attachment12_7" ) ){
                return answerAttachment12Message7( soapMessage );
            } else  if( strActor.equals( "Attachment12_8" ) ){
                return answerAttachment12Message8( soapMessage );
            } else  if( strActor.equals( "Attachment12_9" ) ){
                return answerAttachment12Message9( soapMessage );
            } else  if( strActor.equals( "Attachment12_10" ) ){
                return answerAttachment12Message10( soapMessage );
            }
            // ToDo: test header here
        }
        // May dup with Attachment12_1
        if( strBodyText != null ){
            if( strBodyText.indexOf( "Attachment12_1" ) >= 0 ){
                return answerAttachment12Message1( soapMessage );
            }
        }
        return createError12Message( "The SoapMessage does not have a correcponding response"  );
    }

    private static SOAPMessage answerAttachment12Message1(SOAPMessage inMsg ) throws Exception{
        Name name       = getBodyFirstChildName( inMsg );
        if( name.getLocalName().equals( "Attachment12_1" ) ){
            ...
            mimes2.addHeader( "Content-Id", "<Attachment12SOAPMessage>" ); // IBM SAAJ default
            Iterator iter2     = inMsg.getAttachments( mimes2 );

            MimeHeaders mimes3 = new MimeHeaders();
            mimes3.addHeader( "content-type", "text/xml" );
            mimes3.addHeader( "content-id"  , "<Attachment12SOAPMessage>" );
            ...
            if( iter2.hasNext() ){
                ...
                //AttachmentPart attachment3 = (AttachmentPart)iter3.next();
                //AttachmentPart attachment4 = (AttachmentPart)iter4.next();

                boolean b1 = iter1.hasNext();
                boolean b2 = iter2.hasNext();
                //boolean b3 = iter3.hasNext();
                //boolean b4 = iter4.hasNext();
                if( b1 || b2 /* MH || b3 || b4 */ ){
                    String strError = "Some iterator has extra AttachmentPart: 1:" + b1 +
                                      " 2:" + b2 /* MH + " 3:" + b3 + " 4:" + b4 */;
                    return createError12Message( strError  );
                }
                ...
                if( (attachment1 != attachment2)/* mh ||
                    ...
                    return createError12Message( "Somehow the AttachmentPart is not the same object"  );
                }
                ...
                if( dataHandler != null ){
                    ...
                    if( obj instanceof String ){
                        if( !((String)obj).equals( STR_BODY_ELEMENT_1 ) ){
                            return createError12Message( "The string does not match " + 
                ...
                System.out.println(  );
                return createError12Message( "Iter2 does not have any AttachmentPart"  );
            }


            SOAPHeaderElement soapHeaderElement = getHeaderFirstChild( inMsg );
            if( soapHeaderElement == null ){ // No Header
                return createAttachment12Answer1();
            } else{
                return createError12Message( "The SoapMessage has an Header"  );
            }
        } else{
            return createError12Message( "The SoapMessage does not have \"Attachment12\" BodyElement"  );
        }
    }

    private static SOAPMessage createAttachment12Answer1() throws Exception{
        // SOAP 1.1
        ...
        Name headerName = soapFactory.createName( "Attachment12", "texas", "http://ibm.org/texas" ); // 德州=texas
        SOAPHeaderElement soapHeaderElement = soapHeader.addHeaderElement( headerName );
        Name attrName   = soapFactory.createName( "attrib12" );          // attrib12
        ...
        Name bodyName                   = soapFactory.createName( "Attachment12", "texas", "http://ibm.org/texas"); // 德州=texas
        SOAPBodyElement soapBodyElement = soapBody.addBodyElement( bodyName );

        return soapMessage;
    }

    private static SOAPMessage answerAttachment12Message2(SOAPMessage inMsg ) throws Exception{

        SOAPHeaderElement soapHeaderElem = getHeaderFirstChild(inMsg);
        Name name = soapHeaderElem.getElementName();
        if( name.getLocalName()      .equals( "Attachment12_2" ) &&
            soapHeaderElem.getActor().equals( "Attachment12_2" )
          ){
            ...
            return createError12Message( "The SoapMessage does not have \"home:Attachment12\" HeaderElement"  );
        }
    }
    ...
    private static SOAPMessage checkAttachmentParts2( SOAPMessage soapMessage) throws Exception{
        ...
        if( (iSize != iSize1) || (iSize != 3 ) ){
            return createError12Message( "The size is supposed to be 3 but it's not. " +
                                         " size=" + iSize + 
                                         " size1=" + iSize1 );
        }
        ...
        if( iter2.hasNext() ){
            ...
            if( !strId2.equals( "<lowercaseString>" ) ){
                return createError12Message( "Supposed to get ID 'lowercaseString" +
                                             "' but get '" + strId2 + "'" );
            }
            ...
            if( !( bOught && bMust ) ){
                return createError12Message( "Does not have BOTH OughtToBeKept and mustKeep MimeHeader(s)" );
            }
            // defect 382628
            ...
            if( reviewMinor() ){
                for( int iI = 0; iI < astr2.length; iI ++ ){
                    if( !(astr2[ iI ].equals( "change " + iI ) )){
                        return createError12Message( "Supposed to get 'change " + iI + 
                                                     "' but get '" + astr2[ iI ] + "'" );
                    }
                }
            }
        } else {
           /*mh return createError12Message( "Does not get the multi 'changed' Attachment(lowercaseString'" );*/
        }

        MimeHeaders mimes3 = new MimeHeaders();
        mimes3.addHeader( "content-id", "<Attach12Message>");
        ...
        if( iter3.hasNext() ){
            ...
            while( iter3b.hasNext() ){ 
                ...
                if( strKey3.equalsIgnoreCase( "Content-Id" )){
                    bRight = strValue3.equals( "<Attach12Message>" );
                } else 
                ...
                if( ! bRight ){ // something wrong with getMatchingMimeHeaders()
                    return createError12Message( "Error on getMatchingMimeHeaders(3). see name:'" +
            ...
            while( iter3a.hasNext() ){ 
                ...
                // }
                if( ! bRight ){ // something wrong with getMatchingMimeHeaders()
                    return createError12Message( "Error on getNonMatchingMimeHeaders(3). see name:'" +
                                                 strKey3 + "' value:'" + strValue3 + "'" );
                }
            }
            ...
            return createError12Message( "Does not get the 'Attach12Message'" );
        }
        ...
        if( iter4.hasNext() ){
            ...
            while( iter4b.hasNext() ){ 
                ...
                if( ! bRight ){ // something wrong with getMatchingMimeHeaders()
                    return createError12Message( "Error on getMatchingMimeHeaders(4). see name:'" +
            ...
            while( iter4a.hasNext() ){ 
                ...
                // }
                if( ! bRight ){ // something wrong with getMatchingMimeHeaders()
                    return createError12Message( "Error on getNonMatchingMimeHeaders(4). see name:'" +
                                                 strKey4 + "' value:'" + strValue4 + "'" );
                }
            }
            ...
            return createError12Message( "Does not get the multi 'changed' Attachment(lowercaseString'" );
        }


        return createAttachment12Answer2( );
    }

    private static SOAPMessage createAttachment12Answer2() throws Exception{
        // SOAP 1.1
        MessageFactory  messageFactory  = MessageFactory.newInstance(SOAPConstants.SOAP_1_1_PROTOCOL); 
             // 1.2 need to specify the version
        SOAPMessage     soapMessage     = messageFactory.createMessage();
        ...
        Name headerName = soapFactory.createName( "Attachment12", "good", "http://ibm.org/Texas" );
        SOAPHeaderElement soapHeaderElement = soapHeader.addHeaderElement( headerName );
    ...
    private static SOAPMessage answerAttachment12Message3(SOAPMessage inMsg ) throws Exception{
        ...
        Name name = soapHeaderElem.getElementName();
        if( name.getLocalName().equals( "Attachment12_3" ) &&
            name.getURI().equals( "http://www.ibm.com/pcsupport")&&
            soapHeaderElem.getActor().equals( "Attachment12_3"    )&&
            ...
            if(  iSize != 2 ){
                return createError12Message( "It supposed to have 2 AttacgmentParts but get" +
                                             iSize + " items" );
            }
            ...
            return createAttachment12AnswerCommon("Attachment12_3", "attrib12_3");
        } else{
            return createError12Message( "The SoapMessage does not have a right Attachment12_3 HeaderElement"  );
        }
    }

    private static SOAPMessage createAttachment12AnswerCommon( String strHeader,
                                                               String strAttr
                                                             ) throws Exception{
        // SOAP 1.1
        MessageFactory  messageFactory  = MessageFactory.newInstance(SOAPConstants.SOAP_1_1_PROTOCOL); 
    ...
    // verify getContent()
    private static SOAPMessage answerAttachment12Message4(SOAPMessage inMsg ) throws Exception{

        SOAPHeaderElement soapHeaderElem = getHeaderFirstChild(inMsg);
        Name name = soapHeaderElem.getElementName();
        if( name.getLocalName()      .equals( "Attachment12_4"           ) &&
            soapHeaderElem.getActor().equals( "Attachment12_4"           ) &&
    ...
    private static SOAPMessage checkAttachmentParts4( SOAPMessage soapMessage) throws Exception{
        ...
        if( (iSize != iSize1) || (iSize != 5 ) ){
            return createError12Message( "The size is supposed to be 5 but it's not. " +
                                         " size=" + iSize + 
                                         " size1=" + iSize1 );
        }
        ...
        if( iter2.hasNext() ){
            ...
            if( obj instanceof String ){ // This is a must according to the Document
                ...
                if( !str2.equals( "abcdefghijklmnopqrstuvwxyz" ) ){
                    return createError12Message( "Does not get the string "+
                ...
                return createError12Message( strErr );                                                 
            }
            ...
            return createError12Message( "Does not get the Attachment'lowercaseString'" );
        }

        MimeHeaders mimes3 = new MimeHeaders();
        mimes3.addHeader( "content-id", "<Attachment12SOAPMessage>"); //XML file
        Iterator iter3 = soapMessage.getAttachments( mimes3 );
        if( iter3.hasNext() ){
            AttachmentPart attach3 = (AttachmentPart)iter3.next();
            ...
            if( !(obj instanceof javax.xml.transform.stream.StreamSource) ){ // This is a must according to the Document
                System.out.println( "Attachment12SOAPMessage:" + obj);
                String strErr = "ERROR: getContent() on Attachment12SOAPMessage is expected to get " +
            ...
            return createError12Message( "Does not get the Attachment'Attachment12SOAPMessage'" );
        }
        ...
        if( iter4.hasNext() ){
            ...
            return createError12Message( "Does not get the Attachment 'image3'" );
        }
        ...
        if( iter5.hasNext() ){
            ...
            return createError12Message( "Does not get the Attachment 'gif3'" );
        }
        ...
        if( iter6.hasNext() ){
            ...
            return createError12Message( "Does not get the Attachment 'bmp4'" );
        }


        return createAttachment12Answer2( ); // This is on purpose
    }

    // verify getDataHandler
    private static SOAPMessage answerAttachment12Message5(SOAPMessage inMsg ) throws Exception{

        SOAPHeaderElement soapHeaderElem = getHeaderFirstChild(inMsg);
        Name name = soapHeaderElem.getElementName();
        if( name.getLocalName()      .equals( "Attachment12_5"           ) &&
            soapHeaderElem.getActor().equals( "Attachment12_5"           ) &&
            soapHeaderElem.getValue().equals( "testing in Austin, Texas" ) ){
    ...
    private static SOAPMessage answerAttachment12Message6(SOAPMessage inMsg ) throws Exception{
        ...
        if(  iSize != 1 ){
            // Test failed
            return createError12Message( "It supposed to have 1 AttacgmentParts but get" +
                                         iSize + " items" );
        }
        ...
        return createAttachment12AnswerCommon("Attachment12_6", "attrib12_6" );
    }

    private static SOAPMessage answerAttachment12Message7(SOAPMessage inMsg ) throws Exception{
        ...
        return createAttachment12AnswerCommon("Attachment12_7", "attrib12_7" );
    }


    private static SOAPMessage answerAttachment12Message8(SOAPMessage inMsg ) throws Exception{
        ...
        return createAttachment12AnswerCommon("Attachment12_8", "attrib12_8" );
    }

    private static SOAPMessage answerAttachment12Message9(SOAPMessage inMsg ) throws Exception{
        ...
        return createAttachment12AnswerCommon("Attachment12_9", "attrib12_9" );
    }

    private static SOAPMessage answerAttachment12Message10(SOAPMessage inMsg ) throws Exception{
        ...
        SOAPMessage response = createAttachment12AnswerCommon("Attachment12_10", "attrib12_10" );
    ...
    static SOAPMessage checkImages(Iterator iter1,
        ...
        while( iter1.hasNext() ){
            ...
            if( myCounter.getCount() <= iCount ){
                return createError12Message( "Did not get expected IDs but gets '" +
                                             strID + "'" );
            }
        }
        return null;
    ...
    static SOAPMessage checkImage( AttachmentPart attach1, String strID,
        ...
        if( dataHandler1 == null ){
            return createError12Message(  strID + " DataHandler is null unexpectedly" );
        }
        ...
        if( image == null ){
            ...
            return createError12Message( strMsg );
        } else {
            ...
            if( ! bMatch ){
                return createError12Message( strID + " wXh did not get expected size " +
                                             " but get " + str1 );
            }
        }
        if( iSize < 10000 ){
