...
@WebServiceProvider(targetNamespace="http://fvt.saaj",
                    serviceName="SOAPMessage13Service", portName="SOAPMessage13Port",
                    wsdlLocation="WEB-INF/wsdl/SOAPMessage13Service.wsdl")
public class SOAPMessage13Provider implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage soapMessage) {
        System.out.println("        " );
        System.out.println(">> SOAPMessage13Provider: Request received.");
        ...
        try{
            ...
            System.out.println("***ERROR: In SOAPMessage13Provider.invoke: Caught exception " + e);
