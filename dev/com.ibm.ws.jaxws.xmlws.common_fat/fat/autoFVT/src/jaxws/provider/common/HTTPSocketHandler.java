//
// @(#) 1.3 autoFVT/src/jaxws/provider/common/HTTPSocketHandler.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 12/5/06 11:36:21 [8/8/12 06:54:49]
//
...
/**
 * HTTP Managed Socket Class
 * Enables HTTP POST & Binary communication over a socket 
 */
public class HTTPSocketHandler {
    ...
    public String doPost(String path, String data)
    {
        ...
        try
        {
            ...
            if (DEBUG) System.out.println("##################### HTTP-Request:");
            ...
            if (DEBUG) System.out.println("##################### HTTP-Response:");
            ...
            try
            {
                while ((temp = rd.readLine()) != null)
                {
                    ...
                    if (temp.startsWith("HTTP"))
                    {
                        ...
                        http_status_code = Integer.parseInt(temp.substring(s1 + 1, s2));
                    }
