...
// 08/28/08  whsu           546229          Update OneWay test cases
...
/**
 * This class consists of test cases that verify server side handlers are
 ...
 */
public class HandlersFlowServerTest extends com.ibm.ws.wsfvt.test.framework.FVTTestCase {
     ...
     */
    public HandlersFlowServerTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(HandlersFlowServerTest.class);
    }
    ...
    /**
     * Verifies server handlers execution flow complies with JAX-WS spec.
     *
     * @throws Exception Any kind of exception
     * @testStrategy This test configures server handler chain using 
     *               annotation @HandlerChain.  Verifies handler execution 
     *               flow when server side logical handler handleMessage() 
     *               returns false when processing outbound message.
     */
    ...
    public void testLogicalOutMessageFalse() {
        ...
        try {
            ...
            testPath.add(TestConstants.SERVER_ROLE);
            testPath.add("ServerLogicalHandler");
     ...
     * @testStrategy This test configures server handler chain using
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side SOAP handler handleMessage()
     *               returns false when processing outbound message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    ...
    public void testSOAPOutMessageFalse() {
        ...
        try {
            ArrayList<String> testPath = new ArrayList<String> ();
            testPath.add(TestConstants.SERVER_ROLE);
            testPath.add("ServerSOAPHandler");
            testPath.add(TestConstants.OUTBOUND);
            testPath.add(TestConstants.PATH_FALSE);
     ...
     * @testStrategy This test configures server handler chain using
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side last SOAP handler handleMessage()
     *               returns false when processing outbound message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    ...
    public void testPropOutMessageFalse() {
        ...
        try {
            ArrayList<String> testPath = new ArrayList<String> ();
            testPath.add(TestConstants.SERVER_ROLE);
            testPath.add("ServerPropHandler");
            testPath.add(TestConstants.OUTBOUND);
            testPath.add(TestConstants.PATH_FALSE);
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               throws a ProtocolException when processing outbound 
     *               message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    ...
    public void testLogicalOutMessageProtocolException() {
        ...
        String expClientFlow = "Client:" + 
                    ...
                    "Client_ClientSOAPHandler_handleMessage_Outbound:" + 
                    "Client_ClientPropHandler_handleMessage_Outbound:" + 
                    "Client_ClientPropHandler_handleFault_Inbound:" + 
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               throws a RuntimeException when processing outbound
     *               message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               returns false when processing inbound message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testLogicalInMessageFalse() {
        ...
        try {
			...
			//test the server handler server flow, compare it with expected flow.
			try {
                String actualFlow = TestConstants.getLogFileContents(clientLogfile);
                // String actualFlow = ExecutionFactory.getExecution().executeGetFileContents(clientLogfile, clientHost);
                assertEquals("Incorrect client execution flow", 
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               throws a ProtocolException when processing inbound 
     *               message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    ...
    public void testLogicalInMessageProtocolException() {
        ...
        String expServerFlow =
                    ...
                    "Server_ServerSOAPHandler_handleMessage_Inbound:" +
                    "Server_ServerLogicalHandler_handleMessage_Inbound:" +
                    "Server_ServerSOAPHandler_handleFault_Outbound:" +
                    "Server_ServerPropHandler_handleFault_Outbound:" +
                    "Server_ServerLogicalHandler_close:" +
                    "Server_ServerSOAPHandler_close:" +
                    "Server_ServerPropHandler_close:";
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               throws a RuntimeException when processing inbound
     *               message.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
     ...
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side logical handler handleMessage()
     *               returns false when processing inbound message of a 
     *               OneWay operation.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testLogicalInMessageFalseOneWay() {
        System.err.println("====== In testLogicalInMessageFalseOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testLogicalInMessageFalseOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            try {
                ...
                // make sure server has completed message processing
                Thread.sleep(1000L);
                ExecutionFactory.getExecution().executeCopyFile(serverLogfile, serverHost, localServerLogfile, clientHost);
                actualFlow = TestConstants.getLogFileContents(localServerLogfile);
                // actualFlow = ExecutionFactory.getExecution().executeGetFileContents(serverLogfile, serverHost);
            ...
            System.err.println("====== SUCCESS: testLogicalInMessageFalseOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testLogicalInMessageFalseOneWay() ======\n");
            fail("Exception caught in testLogicalInMessageFalseOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testSOAPInMessageFalseOneWay() {
        System.err.println("====== In testSOAPInMessageFalseOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testSOAPInMessageFalseOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testSOAPInMessageFalseOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testSOAPInMessageFalseOneWay() ======\n");
            fail("Exception caught in testSOAPInMessageFalseOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropInMessageFalseOneWay() {
        System.err.println("====== In testPropInMessageFalseOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropInMessageFalseOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testPropInMessageFalseOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropInMessageFalseOneWay() ======\n");
            fail("Exception caught in testPropInMessageFalseOneWay(): " + e.getClass().getName());
        }
    }
     ...
     *               flow when server side logical handler handleMessage()
     *               throws a ProtocolException when processing inbound 
     *               message of a OneWay operation.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testLogicalInMessageProtocolExceptionOneWay() {
        System.err.println("====== In testLogicalInMessageProtocolExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testLogicalInMessageProtocolExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testLogicalInMessageProtocolExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testLogicalInMessageProtocolExceptionOneWay() ======\n");
            fail("Exception caught in testLogicalInMessageProtocolExceptionOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testSOAPInMessageProtocolExceptionOneWay() {
        System.err.println("====== In testSOAPInMessageProtocolExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testSOAPInMessageProtocolExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testSOAPInMessageProtocolExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testSOAPInMessageProtocolExceptionOneWay() ======\n");
            fail("Exception caught in testSOAPInMessageProtocolExceptionOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropInMessageProtocolExceptionOneWay() {
        System.err.println("====== In testPropInMessageProtocolExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropInMessageProtocolExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testPropInMessageProtocolExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropInMessageProtocolExceptionOneWay() ======\n");
            fail("Exception caught in testPropInMessageProtocolExceptionOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testLogicalInMessageRuntimeExceptionOneWay() {
        System.err.println("====== In testLogicalInMessageRuntimeExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testLogicalInMessageRuntimeExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testLogicalInMessageRuntimeExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testLogicalInMessageRuntimeExceptionOneWay() ======\n");
            fail("Exception caught in testLogicalInMessageRuntimeExceptionOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testSOAPInMessageRuntimeExceptionOneWay() {
        System.err.println("====== In testSOAPInMessageRuntimeExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testSOAPInMessageRuntimeExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testSOAPInMessageRuntimeExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testSOAPInMessageRuntimeExceptionOneWay() ======\n");
            fail("Exception caught in testSOAPInMessageRuntimeExceptionOneWay(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropInMessageRuntimeExceptionOneWay() {
        System.err.println("====== In testPropInMessageRuntimeExceptionOneWay() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropInMessageRuntimeExceptionOneWay() ======\n");
                fail("Failed to configure proxy handler chain");
            }
            ...
            System.err.println("====== SUCCESS: testPropInMessageRuntimeExceptionOneWay() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropInMessageRuntimeExceptionOneWay() ======\n");
            fail("Exception caught in testPropInMessageRuntimeExceptionOneWay(): " + e.getClass().getName());
        }
    }
     ...
     * @testStrategy This test configures server handler chain using
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side last SOAP handler handleFault()
     *               returns false.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropHandleFaultFalse() {
        System.err.println("====== In testPropHandleFaultFalse() ======");
        ...
        try {
            ...
            faultPath.add(TestConstants.SERVER_ROLE);
            faultPath.add("ServerPropHandler");
            faultPath.add(TestConstants.OUTBOUND);
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropHandleFaultFalse() ======\n");
                fail("Failed to configure proxy handler chain");
            }

            int retVal = myPort.countString(testString);
            fail("Should have caught a ProtocolException in testPropHandleFaultFalse()");
            ...
            System.err.println("====== SUCCESS: testPropHandleFaultFalse() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropHandleFaultFalse() ======\n");
            fail("Exception caught in testPropHandleFaultFalse(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropHandleFaultProtocolException() {
        System.err.println("====== In testPropHandleFaultProtocolException() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropHandleFaultProtocolException() ======\n");
                fail("Failed to configure proxy handler chain");
            }

            int retVal = myPort.countString(testString);
            fail("Should have caught a ProtocolException in testPropHandleFaultProtocolException()");
            ...
            System.err.println("====== SUCCESS: testPropHandleFaultProtocolException() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropHandleFaultProtocolException() ======\n");
            fail("Exception caught in testPropHandleFaultProtocolException(): " + e.getClass().getName());
        }
    }
    ...
    expectedResult="",
    since=com.ibm.ws.wsfvt.test.framework.FvtTest.Releases.WSFP)
    public void testPropHandleFaultRuntimeException() {
        System.err.println("====== In testPropHandleFaultRuntimeException() ======");
        ...
        try {
            ...
            if (!configHandlerChain((BindingProvider) myPort)) {
                System.err.println("====== END testPropHandleFaultRuntimeException() ======\n");
                fail("Failed to configure proxy handler chain");
            }

            int retVal = myPort.countString(testString);
            fail("Should have caught a RuntimeException in testPropHandleFaultRuntimeException()");
            ...
            System.err.println("====== SUCCESS: testPropHandleFaultRuntimeException() ======\n");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("====== END testPropHandleFaultRuntimeException() ======\n");
            fail("Exception caught in testPropHandleFaultRuntimeException(): " + e.getClass().getName());
        }
    }
     ...
     * @testStrategy This test configures server handler chain using
     *               annotation @HandlerChain.  Verifies handler execution
     *               flow when server side SOAP handler handleFault()
     *               returns false.
     */
    @com.ibm.ws.wsfvt.test.framework.FvtTest(description="",
    expectedResult="",
    ...
    public void testSOAPHandleFaultFalse() {
        ...
        try {
            ...
            faultPath.add(TestConstants.SERVER_ROLE);
            faultPath.add("ServerSOAPHandler");
            faultPath.add(TestConstants.OUTBOUND);
            faultPath.add(TestConstants.PATH_FALSE);
