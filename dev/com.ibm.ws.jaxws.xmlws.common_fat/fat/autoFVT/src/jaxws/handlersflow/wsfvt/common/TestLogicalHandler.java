...
/**
 * This class implements a JAX-WS LogicalHandler:
 ...
 */
public class TestLogicalHandler implements 
                                LogicalHandler <LogicalMessageContext> {
    private String _handlerName = "TestLogicalHandler"; 
    ...
    public boolean handleFault(LogicalMessageContext lmc) {
        ...
        ArrayList<String> curPath = (ArrayList) lmc.get(TestConstants.FAULT_PATH_PROPERTY);
        ...
        if (curPath != null &&
            ...
            lmc.put(TestConstants.FAULT_PATH_PROPERTY, null);
    ...
    public boolean handleMessage(LogicalMessageContext lmc) {
        ...
        // Execute command targeted for this handler
        ArrayList<String> curPath = (ArrayList) lmc.get(TestConstants.MESSAGE_PATH_PROPERTY);
        ...
        if (curPath != null &&
            ...
            lmc.put(TestConstants.MESSAGE_PATH_PROPERTY, null);
