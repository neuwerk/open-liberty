//
// @(#) 1.2 WautoFVT/src/jaxws/async/wsfvt/server/DocLitWrappedPortImpl.java, WAS.websvcs.fvt, WSFP.WFVT 9/18/06 16:54:53 [9/26/06 09:46:44]
//
...
package jaxws.async.wsfvt.server;
 ...
 */
@WebService(serviceName = "AsyncService", portName = "AsyncPort", targetNamespace = "http://doclitwr.common.wsfvt.async.jaxws", endpointInterface = "jaxws.async.wsfvt.common.doclitwr.AsyncPort", wsdlLocation = "WEB-INF/wsdl/async_doclitwr.wsdl")
	...
	try {
		...
		synchronized (msg) {
			...
			try {
				...
				doCancell = true;
				System.out.println("doCancell set to true");
			} finally {
