//
// @(#) 1.2 autoFVT/src/jaxws/badproxy/wsfvt/common/LogCommands.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 5/2/07 15:47:51 [8/8/12 06:55:25]
//
...
public class LogCommands {
	...
	public String readUpdates() {
		...
		String ret = handler.doGet(path + "?log=" + log
				+ "&marked=true&view=update&server=" + server);
		handler.closeSocket();
