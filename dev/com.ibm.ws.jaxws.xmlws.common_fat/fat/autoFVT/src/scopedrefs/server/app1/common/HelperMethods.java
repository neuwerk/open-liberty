package scopedrefs.server.app1.common;
...
/**
 * Contains some helper methods for looking up and invoking services.
 * If this class is extended, to avoid the tangle of webservice method inheritance,
 * these methods should be called by a public method in the subclass instead.
 * @author btiffany
 *
 */
public class HelperMethods {
     ...
     * of server 1.    One of the methods in the test service will be called to update it. 
     */
