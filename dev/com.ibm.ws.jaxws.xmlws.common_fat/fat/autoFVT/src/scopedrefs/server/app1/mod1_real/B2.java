...
public class B2 {
    ...
    // info in ejb-jar.xml
    @WebServiceRef(name="java:module/env/service/a1m1b2", value=scopedrefs.generatedclients.app1.mod1.b2.B2Service.class )
    B2Service b2ref;
    
    public String identify(){ return "a1m1b2";}
    ...
    public String invokeapp1ModxEjb1(){
        ...
        try{
             ...
             B1Service b1  =                                                                                   
                    (B1Service)ctx.lookup("java:module/env/service/a1m1b1");
