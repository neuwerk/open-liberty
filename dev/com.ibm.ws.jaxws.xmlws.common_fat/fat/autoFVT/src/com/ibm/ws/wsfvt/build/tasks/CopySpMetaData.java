/*
 *
 * @(#) 1.1 autoFVT/src/com/ibm/ws/wsfvt/build/tasks/CopySpMetaData.java, WAS.wssecurity.fvt, WAS85.FVT, cf011231.01 10/12/11 15:21:40 [8/8/12 06:33:12]
 *
...
/**
 * The CopySpMetaData class is a custom task that copied the SP meta data file
 ...
 */
public class CopySpMetaData extends Task {
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            source = Machine.getLocalMachine().getFile(localDir.getAbsolutePath() + "/" + spMetaDataFile);
