...
/**
 * The StopLiberty class is a custom task for stopping liberty.
 * 
 * The class conforms to the standards set in the Ant build framework for
 * creating custom tasks.
 */
public class StartLiberty extends ParentTask {
	
	/**
     * This method executes the command to stop liberty server.
     * 
     * @throws BuildException
     *             An error encountered while stopping liberty
     */
