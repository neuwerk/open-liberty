/*
 * @(#) 1.1 autoFVT/src/com/ibm/ws/wsfvt/build/tasks/ForTask.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 5/23/07 16:49:41 [8/8/12 06:40:28]
 *
...
public class ForTask extends Task {
    ...
    private void doTheTasks() {
        ...
        if (keepgoing && (errorCount != 0) && failOnError) {
            throw new BuildException(
