//
// @(#) 1.2 autoFVT/src/saaj13dev/devtest/wsfvt/saaj13/SAAJNamespacesSOAP12Test.java, WAS.websvcs.fvt, WASX.FVT 5/11/07 17:34:42 [7/23/07 09:49:05]
//
 ...
 * This test is similar to the SAAJNamespacesTest, except this test uses SAAJ 1.3 and
 * SOAP 1.2.
 * 
 ...
 *
 */
public class SAAJNamespacesSOAP12Test extends TestBase {
    ...
    public SAAJNamespacesSOAP12Test(String name) {
        super(name);
    }
    ...
    */
    ...
    javax.xml.soap.SOAPMessage message = 
        ...
        QName qName = new QName(DEFAULT_URI, "BugReport", DEFAULT_PREFIX);
        javax.xml.soap.SOAPHeader header = env.getHeader();
        javax.xml.soap.SOAPHeaderElement she = header.addHeaderElement(qName);
        she.addNamespaceDeclaration(REP_PREFIX, REP_URI);
        qName = new QName(REP_URI, "def", REP_PREFIX);
        she.addAttribute(qName, "ghi");
        qName = new QName(TOP_URI, "def", TOP_PREFIX);
        she.addAttribute(qName, "mno");
        ...
        javax.xml.soap.SOAPBodyElement sbe = body.addBodyElement(qName);
        sbe.addNamespaceDeclaration(REP_PREFIX, REP_URI);
        qName = new QName(REP_URI, "def", REP_PREFIX);
        sbe.addAttribute(qName, "ghi");
        qName = new QName(TOP_URI, "def", TOP_PREFIX);
        sbe.addAttribute(qName, "mno");
    ...
    /**
     * Counts the number of namespace definitions using the DOM methods
     * to find the declared prefixes
     * @param env SOAPEnvelope
     * @param prefix String
     * @param namespace String
    ...
    protected javax.xml.soap.SOAPEnvelope deserialize(String data)
       throws Exception
    {
    	// Try creating a dynamic SOAPFactory..
    	// I believe the code should adjust during the reading of the string.
    	IBMSOAPFactory sf = (IBMSOAPFactory) SOAPFactory.newInstance(SOAPConstants.DYNAMIC_SOAP_PROTOCOL);
