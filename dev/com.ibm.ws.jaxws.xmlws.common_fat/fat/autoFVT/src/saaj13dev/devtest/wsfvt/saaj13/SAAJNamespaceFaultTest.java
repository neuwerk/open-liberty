//
// @(#) 1.1 autoFVT/src/saaj13dev/devtest/wsfvt/saaj13/SAAJNamespaceFaultTest.java, WAS.websvcs.fvt, WASX.FVT 8/2/06 08:56:39 [7/23/07 09:49:04]
//
 ...
 *    <soapenv:Body>
 *       <soapenv:Fault>
 *       <faultCode>top:sample</faultCode>
 *       <faultString>hello</faultString>
 *       <detail>
 ...
 *
 */
public class SAAJNamespaceFaultTest extends TestBase {
    ...
    public SAAJNamespaceFaultTest(String name) {
        super(name);
    }
    ...
    */
    ...
    javax.xml.soap.SOAPMessage message = 
        ...
        javax.xml.soap.SOAPFault fault = body.addFault(name, "hello");
    ...
    javax.xml.soap.SOAPMessage message = 
        ...
        SOAPElement seFaultCode = (SOAPElement)
            sf.createElement("faultCode");
        seFaultCode.addTextNode("top:sample");
        seFault.appendChild(seFaultCode);

        SOAPElement seFaultString = (SOAPElement)
            sf.createElement("faultString");
        seFaultString.addTextNode("hello");
        seFault.appendChild(seFaultString);

        SOAPElement seDetail = (SOAPElement)
            sf.createElement("detail");
