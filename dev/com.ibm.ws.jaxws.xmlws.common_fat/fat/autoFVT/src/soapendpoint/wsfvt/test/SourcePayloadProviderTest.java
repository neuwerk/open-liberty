 ...
 * 
 * This is a test for a Soruce Payload Provider.
 */
public class SourcePayloadProviderTest extends FVTTestCase {
	...
	private static String endpointUrl = "http://" + hostName + ":" + port + "/soapendpoint/SourcePayloadProviderService";
