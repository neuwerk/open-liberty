 ...
 * 
 * This is a test for a Provider that has a wsdlLocation specified.
 */
public class StringWSDL11PayloadProviderTest extends FVTTestCase {

	private static QName serviceName = new QName("http://ws.apache.org/axis2",
			"StringWSDL11PayloadProviderService");

	private static QName portName = new QName("http://ws.apache.org/axis2",
			"StringWSDL11PayloadProviderServicePort");
	...
	private static String endpointUrl = "http://" + hostName + ":" + port
			+ "/soapendpoint/StringWSDL11PayloadProviderService";
	 ...
	 */
	/* 
	 * Comment out as cxf respects wsdl:binding even RespectBindingFeature is disabled
	 *
	 */
	/*
