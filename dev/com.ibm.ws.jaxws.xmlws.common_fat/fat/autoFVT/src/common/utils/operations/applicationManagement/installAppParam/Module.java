/*
 * @(#) 1.1 autoFVT/src/common/utils/operations/applicationManagement/installAppParam/Module.java, WAS.websvcs.fvt, WAS85.FVT, cf011231.01 11/11/08 10:56:17 [8/8/12 06:41:12]
 *
...
/**
 * The module class contains the basic attributes of a module, such as its name, description and uri.
 */
public class Module {
	 ...
	 * @param uri
	 *            A String containing the module uri
	 */
	 ...
	 * 
	 * @param uri
	 *            A String containing the name of the URI
	 */
	 ...
	 * 
	 * @param moduleDesc
	 *            A String containing the module desc
	 */
