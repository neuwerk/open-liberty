...
public class MessageModeOutInterceptor extends AbstractPhaseInterceptor<Message> {
	...
	private static final Logger LOG = LogUtils.getL7dLogger(MessageModeOutInterceptor.class);
    ...
    private class MessageModeOutInterceptorInternal extends AbstractSoapInterceptor {
        ...
        public void handleMessage(SoapMessage message) throws Fault {
        	//LOG.info("@TJJ MessageModeOutInterceptor$MessageModeOutInterceptorInternal.handleMessage(SoapMessage message) entry: " + message);
        	MessageContentsList list = (MessageContentsList)message.getContent(List.class);
            ...
            //LOG.info("@TJJ MessageModeOutInterceptor$MessageModeOutInterceptorInternal.handleMessage(SoapMessage message) exit: " + message);
